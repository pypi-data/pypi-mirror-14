...
class DereplicationWorkflow(object):
	...
	self.logger.info('Retained %d representatives.' % retained_reps)
        self.logger.info('Retained %d genomes additional genomes in order to establish %s genomes per species.' % (additional_reps, max_species))
