...
class ChartData(object):
    ...
    def __init__(self, chart_id, database, group, permissions_list, groups_list, chart_handler, queries, columns, chart_type):
...
def _parse_charts(charts_xml):
    ...
    for chart in charts:
        ...
        if chart.find("type") is not None:
            ...
            chart_type = "Table"
        parsed_charts[chart_id] = ChartData(chart_id, db, group, permissions_list, groups_list, chart_handler, current_queries, current_columns, chart_type)
