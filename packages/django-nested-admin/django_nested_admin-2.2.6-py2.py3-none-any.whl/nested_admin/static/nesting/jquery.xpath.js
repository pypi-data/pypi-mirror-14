...
var cQuery		= window.django.jQuery,
...
function xpath_cls(classname) { return 'contains(concat(" ", @class, " "), " ' + classname + ' ")'; }

function xpath_item() {
    var xpath_item_predicate = 'not(contains(@class, "-drag")) and not(self::thead)';
    return [xpath_item_predicate, xpath_cls('djn-item')].join(" and ");
}
