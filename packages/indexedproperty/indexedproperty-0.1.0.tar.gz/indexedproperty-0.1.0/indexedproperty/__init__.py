...
class ContainerProperty(IndexedProperty):
	...
	ContainerProperty objects should generally be created with the
	@containerproperty decorator rather than directly.
	"""
...
class RangeProperty(IndexedProperty):
	...
	RangeProperty instances should generally be created with the @rangeproperty
	descriptor, not directly.
	"""
	...
	def __init__(self, start, stop, getter=None, **kwargs):
		super().__init__(getter, **kwargs)
		if stop < start:
