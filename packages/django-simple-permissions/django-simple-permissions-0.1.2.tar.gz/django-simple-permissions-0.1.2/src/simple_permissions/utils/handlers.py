...
from simple_permissions.compat import isstr
from simple_permissions.compat import import_string
...
class PermissionHandlerRegistry(object):
    ...
    def register(self, model, handler=None):
        ...
        """
        from simple_permissions.handlers import PermissionHandler
