...
class ThirdTest(LucteriosTest):
    ...
    def test_add_individual(self):
        ...
        self.assert_attrib_equal(
            'COMPONENTS/BUTTON[@name="show"]/ACTIONS/ACTION', 'extension', 'lucterios.contacts')
        self.assert_attrib_equal(
            'COMPONENTS/BUTTON[@name="show"]/ACTIONS/ACTION', 'action', 'individualShow')
        self.assert_xml_equal(
            'COMPONENTS/BUTTON[@name="show"]/ACTIONS/ACTION/PARAM[@name="individual"]', '3')
    ...
    def test_show_withdata(self):
        ...
        self.assert_xml_equal(
            'COMPONENTS/GRID[@name="entrylineaccount"]/RECORD[3]/VALUE[@name="debit"]', '34.01€')
        self.assert_xml_equal(
            'COMPONENTS/GRID[@name="entrylineaccount"]/RECORD[3]/VALUE[@name="entry.link"]', '---')

        self.factory.xfer = AccountThirdDel()
        self.call(
            '/diacamma.accounting/accountThirdDel', {"accountthird": 6}, False)
        self.assert_observer(
            'core.exception', 'diacamma.accounting', 'accountThirdDel')
        self.assert_xml_equal(
            'EXCEPTION/MESSAGE', "Ce compte comporte des écritures!")
    ...
    def test_show_withdata_linesfilter(self):
        ...
        self.assert_count_equal(
            'COMPONENTS/GRID[@name="entrylineaccount"]/HEADER', 9)
        self.assert_count_equal(
            'COMPONENTS/GRID[@name="entrylineaccount"]/RECORD', 1)
    ...
    def test_list(self):
        ...
        self.assert_xml_equal(
            'COMPONENTS/GRID[@name="third"]/HEADER[@name="contact"]', "contact")
        self.assert_xml_equal(
            'COMPONENTS/GRID[@name="third"]/HEADER[@name="accountthird_set"]', "compte")
    ...
    def test_list_withfilter(self):
        ...
        self.factory.xfer = ThirdList()
        self.call(
            '/diacamma.accounting/thirdListing', {'filter': 'joe'}, False)
        self.assert_observer(
            'core.custom', 'diacamma.accounting', 'thirdListing')
        self.assert_count_equal('COMPONENTS/*', 8)
        self.assert_count_equal('COMPONENTS/GRID[@name="third"]/HEADER', 2)
    ...
    def test_list_display(self):
        ...
        self.factory.xfer = ThirdList()
        self.call(
            '/diacamma.accounting/thirdListing', {'show_filter': '1'}, False)
        self.assert_observer(
            'core.custom', 'diacamma.accounting', 'thirdListing')
        self.assert_count_equal('COMPONENTS/*', 8)
        ...
        self.assert_xml_equal(
            'COMPONENTS/GRID[@name="third"]/HEADER[@name="accountthird_set"]', "compte")
        self.assert_xml_equal(
            'COMPONENTS/GRID[@name="third"]/HEADER[@name="total"]', "total")
        self.assert_count_equal('COMPONENTS/GRID[@name="third"]/RECORD', 7)
        self.assert_xml_equal(
            'COMPONENTS/GRID[@name="third"]/RECORD[2]/VALUE[@name="contact"]', 'Dalton Jack')
        self.assert_xml_equal(
        ...
        self.factory.xfer = ThirdList()
        self.call(
            '/diacamma.accounting/thirdListing', {'show_filter': '2'}, False)
        self.assert_observer(
            'core.custom', 'diacamma.accounting', 'thirdListing')
        self.assert_count_equal('COMPONENTS/*', 8)
        self.assert_count_equal('COMPONENTS/GRID[@name="third"]/HEADER', 3)
    ...
    def test_listing(self):
        ...
        self.assert_count_equal(
            'COMPONENTS/SELECT[@name="PRINT_MODE"]/CASE', 2)
        self.assert_comp_equal(
            'COMPONENTS/SELECT[@name="MODEL"]', "5", (1, 1, 1, 1))
        ...
        self.assert_observer(
            'core.print', 'diacamma.accounting', 'thirdListing')
        csv_value = b64decode(
        ...
        self.call('/diacamma.accounting/individualListing',
                  {'PRINT_MODE': '4', 'MODEL': 5, 'filter': 'joe'}, False)
        self.assert_observer(
            'core.print', 'diacamma.accounting', 'individualListing')
        csv_value = b64decode(
            six.text_type(self.get_first_xpath('PRINT').text)).decode("utf-8")
        content_csv = csv_value.split('\n')
        ...
        self.factory.xfer = ThirdListing()
        self.call('/diacamma.accounting/individualListing',
                  {'PRINT_MODE': '4', 'MODEL': 5, 'show_filter': '2'}, False)
        self.assert_observer(
            'core.print', 'diacamma.accounting', 'individualListing')
        csv_value = b64decode(
            six.text_type(self.get_first_xpath('PRINT').text)).decode("utf-8")
    ...
    def test_list_disable(self):
        ...
        self.assert_observer(
            'core.custom', 'diacamma.accounting', 'thirdDisable')
        self.assert_count_equal('COMPONENTS/*', 3)

        self.factory.xfer = ThirdDisable()
        self.call('/diacamma.accounting/thirdDisable',
                  {'limit_date': '2015-02-18'}, False)
        self.assert_observer(
            'core.acknowledge', 'diacamma.accounting', 'thirdDisable')
...
class AdminTest(LucteriosTest):
    ...
    def test_summary(self):
        ...
        self.assert_action_equal(
            "COMPONENTS/BUTTON[@name='accounting_conf']/ACTIONS/ACTION", ("conf.", None, 'diacamma.accounting', 'configuration', 0, 1, 1))
    ...
    def test_default_configuration(self):
        ...
        self.assert_xml_equal(
            'COMPONENTS/GRID[@name="fiscalyear"]/HEADER[@name="begin"]', "début")
        self.assert_xml_equal(
            'COMPONENTS/GRID[@name="fiscalyear"]/HEADER[@name="end"]', "fin")
        self.assert_xml_equal(
            'COMPONENTS/GRID[@name="fiscalyear"]/HEADER[@name="status"]', "status")
        self.assert_xml_equal(
            'COMPONENTS/GRID[@name="fiscalyear"]/HEADER[@name="is_actif"]', "actif")
        self.assert_count_equal(
        ...
        self.assert_xml_equal(
            'COMPONENTS/GRID[@name="journal"]/HEADER[@name="name"]', "nom")
        ...
        self.assert_xml_equal(
            'COMPONENTS/LABELFORM[@name="accounting-devise-iso"]', 'EUR')
        self.assert_xml_equal(
            'COMPONENTS/LABELFORM[@name="accounting-devise-prec"]', '2')

    def test_configuration_journal(self):
        self.factory.xfer = JournalAddModify()
        self.call(
            '/diacamma.accounting/journalAddModify', {'journal': '2'}, False)
        self.assert_observer(
        ...
        self.call('/diacamma.accounting/journalAddModify',
                  {'SAVE': 'YES', 'journal': '2', 'name': 'Dépense'}, False)
        self.assert_observer(
            'core.acknowledge', 'diacamma.accounting', 'journalAddModify')

        self.factory.xfer = Configuration()
        self.call('/diacamma.accounting/configuration', {}, False)
        self.assert_count_equal('COMPONENTS/GRID[@name="journal"]/RECORD', 5)
        self.assert_xml_equal(
            'COMPONENTS/GRID[@name="journal"]/RECORD[@id="2"]/VALUE[@name="name"]', 'Dépense')

        self.factory.xfer = JournalAddModify()
        self.call('/diacamma.accounting/journalAddModify',
                  {'SAVE': 'YES', 'name': 'Caisse'}, False)
        self.assert_observer(
            'core.acknowledge', 'diacamma.accounting', 'journalAddModify')
        ...
        self.assert_xml_equal(
            'COMPONENTS/GRID[@name="journal"]/RECORD[@id="6"]/VALUE[@name="name"]', 'Caisse')

        self.factory.xfer = JournalDel()
        self.call(
            '/diacamma.accounting/journalAddModify', {'journal': '2'}, False)
        self.assert_observer(
            'core.exception', 'diacamma.accounting', 'journalAddModify')
        self.assert_xml_equal('EXCEPTION/MESSAGE', 'journal réservé!')

        self.factory.xfer = JournalDel()
        self.call('/diacamma.accounting/journalAddModify',
                  {'CONFIRME': 'YES', 'journal': '6'}, False)
        self.assert_observer(
            'core.acknowledge', 'diacamma.accounting', 'journalAddModify')
    ...
    def test_configuration_fiscalyear(self):
        ...
        self.assert_observer(
            'core.exception', 'diacamma.accounting', 'fiscalYearAddModify')
        self.assert_xml_equal(
            'EXCEPTION/MESSAGE', "Système comptable non défini!")
        ...
        self.call('/diacamma.accounting/fiscalYearAddModify', {}, False)
        self.assert_observer(
            'core.custom', 'diacamma.accounting', 'fiscalYearAddModify')
        self.assert_count_equal('COMPONENTS/*', 7)
        self.assert_xml_equal(
            'COMPONENTS/LABELFORM[@name="status"]', 'en création')
        self.assert_xml_equal(
            'COMPONENTS/DATE[@name="begin"]', to_day.isoformat())
        self.assert_xml_equal(
            'COMPONENTS/DATE[@name="end"]', to_day_plus_1.isoformat())

        self.factory.xfer = FiscalYearAddModify()
        self.call('/diacamma.accounting/fiscalYearAddModify',
                  {'SAVE': 'YES', 'begin': '2015-07-01', 'end': '2016-06-30'}, False)
        self.assert_observer(
            'core.acknowledge', 'diacamma.accounting', 'fiscalYearAddModify')
        ...
        self.assert_count_equal(
            'COMPONENTS/GRID[@name="fiscalyear"]/HEADER', 4)
        self.assert_count_equal(
            'COMPONENTS/GRID[@name="fiscalyear"]/RECORD', 1)
        self.assert_xml_equal(
            'COMPONENTS/GRID[@name="fiscalyear"]/RECORD[1]/VALUE[@name="begin"]', '1 juillet 2015')
        self.assert_xml_equal(
            'COMPONENTS/GRID[@name="fiscalyear"]/RECORD[1]/VALUE[@name="end"]', '30 juin 2016')
        self.assert_xml_equal(
            'COMPONENTS/GRID[@name="fiscalyear"]/RECORD[1]/VALUE[@name="status"]', "en création")
        self.assert_xml_equal(
        ...
        self.assert_xml_equal(
            'COMPONENTS/LABELFORM[@name="status"]', 'en création')
        self.assert_xml_equal(
            'COMPONENTS/LABELFORM[@name="begin"]', '1 juillet 2016')
        self.assert_xml_equal('COMPONENTS/DATE[@name="end"]', '2017-06-30')

        self.factory.xfer = FiscalYearAddModify()
        self.call('/diacamma.accounting/fiscalYearAddModify',
                  {'SAVE': 'YES', 'begin': '2016-07-01', 'end': '2017-06-30'}, False)
        self.assert_observer(
            'core.acknowledge', 'diacamma.accounting', 'fiscalYearAddModify')
        ...
        self.assert_count_equal(
            'COMPONENTS/GRID[@name="fiscalyear"]/HEADER', 4)
        self.assert_count_equal(
            'COMPONENTS/GRID[@name="fiscalyear"]/RECORD', 2)
        self.assert_xml_equal(
            'COMPONENTS/GRID[@name="fiscalyear"]/RECORD[2]/VALUE[@name="begin"]', '1 juillet 2016')
        self.assert_xml_equal(
            'COMPONENTS/GRID[@name="fiscalyear"]/RECORD[2]/VALUE[@name="end"]', '30 juin 2017')
        self.assert_xml_equal(
            'COMPONENTS/GRID[@name="fiscalyear"]/RECORD[2]/VALUE[@name="status"]', "en création")
        self.assert_xml_equal(
        ...
        self.call(
            '/diacamma.accounting/fiscalYearActive', {'fiscalyear': '2'}, False)
        self.assert_observer(
            'core.acknowledge', 'diacamma.accounting', 'fiscalYearActive')
        ...
        self.assert_count_equal(
            'COMPONENTS/GRID[@name="fiscalyear"]/RECORD', 2)
        self.assert_xml_equal(
            'COMPONENTS/GRID[@name="fiscalyear"]/RECORD[1]/VALUE[@name="is_actif"]', "0")
        self.assert_xml_equal(
            'COMPONENTS/GRID[@name="fiscalyear"]/RECORD[2]/VALUE[@name="is_actif"]', "1")

        self.factory.xfer = FiscalYearAddModify()
        self.call(
            '/diacamma.accounting/fiscalYearAddModify', {'fiscalyear': '1'}, False)
        self.assert_observer(
            'core.exception', 'diacamma.accounting', 'fiscalYearAddModify')
        self.assert_xml_equal(
            'EXCEPTION/MESSAGE', "Cet exercice n'est pas le dernier!")

        self.factory.xfer = FiscalYearAddModify()
        self.call(
            '/diacamma.accounting/fiscalYearAddModify', {'fiscalyear': '2'}, False)
        self.assert_observer(
            'core.custom', 'diacamma.accounting', 'fiscalYearAddModify')
        self.assert_count_equal('COMPONENTS/*', 7)
        self.assert_xml_equal(
    ...
    def test_confi_delete(self):
        ...
        self.assert_observer(
            'core.custom', 'diacamma.accounting', 'configuration')
        self.assert_count_equal(
            'COMPONENTS/GRID[@name="fiscalyear"]/RECORD', 3)

        self.factory.xfer = FiscalYearDel()
        self.call(
            '/diacamma.accounting/fiscalYearDel', {'fiscalyear': '1'}, False)
        self.assert_observer(
            'core.exception', 'diacamma.accounting', 'fiscalYearDel')
        self.assert_xml_equal(
            'EXCEPTION/MESSAGE', "Cet exercice n'est pas le dernier!")
        ...
        self.call('/diacamma.accounting/fiscalYearDel',
                  {'CONFIRME': 'YES', 'fiscalyear': '3'}, False)
        self.assert_observer(
            'core.acknowledge', 'diacamma.accounting', 'fiscalYearDel')
    ...
    def test_system_accounting(self):
        self.assertEqual(
            get_accounting_system('').__class__.__name__, "DefaultSystemAccounting")
        self.assertEqual(get_accounting_system(
            'accountingsystem.foo.DummySystemAcounting').__class__.__name__, "DefaultSystemAccounting")
        self.assertEqual(get_accounting_system(
            'diacamma.accounting.system.french.DummySystemAcounting').__class__.__name__, "DefaultSystemAccounting")
        self.assertEqual(get_accounting_system(
            'diacamma.accounting.system.french.FrenchSystemAcounting').__class__.__name__, "FrenchSystemAcounting")

        self.assertEqual(
            current_system_account().__class__.__name__, "DefaultSystemAccounting")
        set_accounting_system()
        self.assertEqual(
            current_system_account().__class__.__name__, "FrenchSystemAcounting")
...
class ModelTest(LucteriosTest):
    ...
    def test_add(self):
        ...
        self.assert_observer(
            'core.custom', 'diacamma.accounting', 'modelEntryList')
        self.assert_count_equal('COMPONENTS/*', 4)
        self.assert_count_equal(
            'COMPONENTS/GRID[@name="modelentry"]/HEADER', 3)
        self.assert_xml_equal(
            'COMPONENTS/GRID[@name="modelentry"]/HEADER[@name="journal"]', "journal")
        self.assert_xml_equal(
            'COMPONENTS/GRID[@name="modelentry"]/HEADER[@name="designation"]', "nom")
        self.assert_xml_equal(
            'COMPONENTS/GRID[@name="modelentry"]/HEADER[@name="total"]', "total")
        self.assert_count_equal(
            'COMPONENTS/GRID[@name="modelentry"]/RECORD', 0)

        self.factory.xfer = ModelEntryAddModify()
        self.call('/diacamma.accounting/modelEntryAddModify', {}, False)
        self.assert_observer(
            'core.custom', 'diacamma.accounting', 'modelEntryAddModify')
        self.assert_count_equal('COMPONENTS/*', 5)
        self.assert_count_equal('COMPONENTS/SELECT[@name="journal"]/CASE', 4)

        self.factory.xfer = ModelEntryAddModify()
        self.call('/diacamma.accounting/modelEntryAddModify',
                  {'SAVE': 'YES', 'journal': '2', 'designation': 'foo'}, False)
        self.assert_observer(
            'core.acknowledge', 'diacamma.accounting', 'modelEntryAddModify')
        ...
        self.assert_xml_equal(
            'COMPONENTS/GRID[@name="modelentry"]/RECORD[1]/VALUE[@name="total"]', "0.00€")
    ...
    def test_addline(self):
        ...
        self.call('/diacamma.accounting/modelLineEntryAddModify',
                  {'modelentry': '1'}, False)
        self.assert_observer(
            'core.custom', 'diacamma.accounting', 'modelLineEntryAddModify')
        self.assert_count_equal('COMPONENTS/*', 7)
        self.assert_xml_equal('COMPONENTS/EDIT[@name="code"]', None)
        ...
        self.assert_observer(
            'core.acknowledge', 'diacamma.accounting', 'modelLineEntryAddModify')
        ...
        self.assert_xml_equal(
            'COMPONENTS/GRID[@name="modelentry"]/RECORD[1]/VALUE[@name="designation"]', "foo")
        self.assert_xml_equal(
            'COMPONENTS/GRID[@name="modelentry"]/RECORD[1]/VALUE[@name="total"]', "19.37€")
    ...
    def test_selector(self):
        ...
        self.assert_observer(
            'core.custom', 'diacamma.accounting', 'modelEntrySelector')
        self.assert_count_equal('COMPONENTS/*', 5)
        ...
        self.factory.xfer = ModelEntrySelector()
        self.call(
            '/diacamma.accounting/modelEntrySelector', {'journal': 2}, False)
        self.assert_observer(
            'core.custom', 'diacamma.accounting', 'modelEntrySelector')
        self.assert_count_equal('COMPONENTS/*', 5)
        self.assert_count_equal('COMPONENTS/SELECT[@name="model"]/CASE', 1)
    ...
    def test_insert(self):
        add_models()
        self.factory.xfer = ModelEntrySelector()
        self.call('/diacamma.accounting/modelEntrySelector',
                  {'SAVE': 'YES', 'journal': '2', 'model': 1, 'factor': 2.50}, False)
        self.assert_observer(
            'core.acknowledge', 'diacamma.accounting', 'modelEntrySelector')
        ...
        self.assertEqual(
            serial_entry[0][-20:], "|1|3|48.430000|None|", serial_entry[0])
        self.assertEqual(
            serial_entry[1][-21:], "|2|0|-48.430000|None|", serial_entry[1])
