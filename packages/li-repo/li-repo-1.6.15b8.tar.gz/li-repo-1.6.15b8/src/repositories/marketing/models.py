...
"""
#########################################################################################################
                        abaixo marketing/models.py que estava em LI-AppPainel
#########################################################################################################
"""
# -*- coding: utf-8 -*-
import datetime
...
class CupomDesconto(models.Model):
    ...
    def clean(self, *args, **kwargs):
        ...
        if not utils.validar_validade_cupom(self.validade):
            raise ValidationError(u"Data do cupom inválida, a data precisa estar no futuro.")
...
class XML(models.Model):
    ...
    url_cadastro = models.URLField(db_column='xml_url_cadastro', null=True, unique=True)
...
class XmlConfiguracao(models.Model):
    ...
    produtos = models.ManyToManyField("catalogo.Produto", related_name="xmls_configuracoes", through='XmlProduto')
...
class Banner(models.Model):
    ...
    link = models.CharField(db_column="banner_link", max_length=256, null=True)
    ...
    mapa_imagem = models.TextField(db_column="banner_mapa_imagem", default=None, null=True)
