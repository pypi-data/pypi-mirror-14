...
"""
######################################################
abaixo plataforma/models.py que estava em LI-AppPainel
######################################################
...
from repositories.domain.models import UUIDField, LOGRADOUROS
from repositories.libs import utils, novo_template_definicoes
...
class Pagina(models.Model):
    ...
    data_criacao = models.DateTimeField(
        db_column="pagina_data_criacao",
        auto_now_add=True)
    data_modificacao = models.DateTimeField(
        db_column="pagina_data_modificacao",
        auto_now=True)
...
class Usuario(models.Model):
    ...
    data_criacao = models.DateTimeField(
        db_column="usuario_data_criacao",
        auto_now_add=True)
    data_modificacao = models.DateTimeField(
        db_column="usuario_data_modificacao",
        auto_now=True,
        null=True)
    data_ultimo_login = models.DateTimeField(
        db_column="usuario_data_ultimo_login",
        null=True,
        default=None)

    chave = UUIDField(db_column="usuario_chave")
    ...
    def reenviar_senha(self, request):
        """
        Envia um email para o usuário com os
        passos para redefinir a sua senha.
        """
...
class Conta(models.Model):
    ...
    nome_loja = models.CharField(
        ...
        null=True,
        default=None)
    nome_loja_title = models.CharField(
        db_column="conta_loja_nome_title",
        max_length=128,
        null=True,
        default=None)
    ...
    css = models.TextField(
        db_column="conta_loja_css",
        default=None,
        null=True,
        blank=True)
    descricao = models.TextField(
        db_column="conta_loja_descricao",
        null=True,
        default=None)

    loja_tipo = models.CharField(
        db_column="conta_loja_tipo",
        max_length=2,
        choices=CONTA_TIPO,
        null=True,
        default=None)
    loja_cpf_cnpj = models.CharField(
        db_column="conta_loja_cpf_cnpj",
        max_length=15,
        null=True,
        default=None)
    loja_razao_social = models.CharField(
        db_column="conta_loja_razao_social",
        max_length=128,
        null=True,
        default=None)
    loja_nome_responsavel = models.CharField(
        db_column="conta_loja_nome_responsavel",
        max_length=128,
        null=True,
        default=None)

    loja_layout = models.TextField(
        db_column="conta_loja_layout",
        null=True,
        default=None)
    ultimo_pedido = models.IntegerField(
        db_column="conta_loja_ultimo_pedido",
        default=0)
    tipo_listagem = models.CharField(
        db_column="conta_loja_tipo_listagem_produto",
        max_length=32,
        null=False,
        choices=TIPO_LISTAGEM,
        default="alfabetica")
    quantidade_destaque = models.IntegerField(
        db_column='conta_loja_quantidade_destaque',
        null=False,
        default=24)
    ranking_json = JSONField(
        db_column='conta_ranking_json',
        null=False,
        default=None)
    produtos_linha = models.IntegerField(
        db_column='conta_loja_produtos_linha',
        null=False,
        default=4)
    banner_ebit = models.TextField(
        db_column='conta_loja_banner_ebit',
        null=True,
        blank=True)
    selo_ebit = models.TextField(
        db_column='conta_loja_selo_ebit',
        null=True,
        blank=True)
    selo_google_safe = models.BooleanField(
        db_column="conta_loja_selo_google_safe",
        null=False,
        default=False)
    selo_norton_secured = models.BooleanField(
        db_column="conta_loja_selo_norton_secured",
        null=False,
        default=False)
    selo_seomaster = models.BooleanField(
        db_column="conta_loja_selo_seomaster",
        null=False,
        default=True)
    comentarios_produtos = models.BooleanField(
        db_column="conta_loja_comentarios_produtos",
        default=True)
    ...
    pedido_valor_minimo = models.DecimalField(
        db_column='conta_pedido_valor_minimo',
        max_digits=16,
        decimal_places=3,
        blank=True
    )
    ...
    utm_campaign = models.CharField(
        max_length=255,
        db_column='conta_utm_campaign',
        null=True)
    utm_source = models.CharField(
        max_length=255,
        db_column='conta_utm_source',
        null=True)
    utm_medium = models.CharField(
        max_length=255,
        db_column='conta_utm_medium',
        null=True)
    utm_term = models.CharField(
        max_length=255,
        db_column='conta_utm_term',
        null=True)
    principal_redirect = models.CharField(
        max_length=64,
        db_column='conta_principal_redirect',
        null=True)
    conteudo_json = JSONField(
        db_column='conta_conteudo_json',
        null=True,
        default=None)

    email_webmaster_verificado = models.NullBooleanField(
        db_column="conta_email_webmaster_verificado",
        null=True,
        default=False)

    gerenciar_cliente = models.BooleanField(
        db_column='conta_gerenciar_cliente',
        default=False,
        null=False)
    chave = UUIDField(db_column="conta_chave")
    wizard_finalizado = models.BooleanField(
        db_column="conta_wizard_finalizado",
        default=False)
    ...
    origem_pro = models.BooleanField(
        db_column="conta_origem_pro",
        null=False,
        default=False)

    atividades = models.ManyToManyField(
        'plataforma.Atividade',
        through="plataforma.ContaAtividade",
        related_name="contas")
    atividades.help_text = u''

    valor_produto_restrito = models.BooleanField(
        db_column="conta_valor_produto_restrito",
        null=False,
        default=False)
    ...
    def tem_certificado_ativo(self):
        return ContaCertificado.objects.filter(
            situacao='ativo', conta_id=self.id).exists()

    @property
    def email_pedido(self):
        return '"%s" <nao-responder@%s>' % (
            self.nome_loja or '', self.contrato.dominio)
    ...
    def adicionar_dominio_alternativo(self, fqdn, principal=False):
        ...
        try:
            existencia = Dominio.objects.only('id').get(
                conta_id=self.id,
                principal=True)
        except Exception:
            principal = True
    ...
    def verificar_pedido_minimo(self, valor):
        ...
        if valor >= self.pedido_valor_minimo:
            return {'status': 'valido'}
        from libs.utils import formatar_decimal_br
    ...
    def proximo_numero_pedido(self):
        ...
        from pedido.models import PedidoVenda
        try:
            minimo = self.pedidos_vendas.only(
                'numero').get(numero=proximo_pedido)
    ...
    def usuario(self):
        try:
            conta_usuario = ContaUsuario.objects.filter(
                conta=self).order_by('-administrador')[0]
    ...
    def copiar_dados_teste(self):
        ...
        try:
            conta_original = Conta.objects.get(
                apelido=self.CONTA_TESTE_APELIDO)
        except Conta.DoesNotExist:
            return None
    ...
    def painel_resumo(cls, conta_id):
        ...
        if resumo['vendas'] > 0:
            resumo['porcentagem_vendas_aprovadas'] = float(
                resumo['vendas_aprovadas']) / resumo['vendas'] * 100.0
            resumo['porcentagem_vendas_canceladas'] = float(
                resumo['vendas_canceladas']) / resumo['vendas'] * 100.0
            resumo['porcentagem_vendas_pendentes'] = float(
                resumo['vendas_pendentes']) / resumo['vendas'] * 100.0
        else:
...
class ContaCertificado(models.Model):
    ...
    situacao = models.CharField(
        ...
        max_length=32,
        choices=CONTA_CERTIFICADO_SITUACAO,
        default=SITUACAO_PENDENTE)
    ...
    conta = models.ForeignKey(
        'plataforma.Conta',
        related_name='conta_certificado',
        on_delete=models.CASCADE)
    contrato = models.ForeignKey(
        'plataforma.Contrato',
        related_name="contas_certificados")
...
class ContaAtividade(models.Model):
    ...
    conta = models.ForeignKey(
        'plataforma.Conta',
        related_name="conta_atividades")
    atividade = models.ForeignKey(
        'plataforma.Atividade',
        related_name="contas_atividade")
    contrato = models.ForeignKey(
        'plataforma.Contrato',
        related_name="contas_atividades")
...
class ContaUsuario(models.Model):
    ...
    id = custom_models.BigAutoField(
        db_column="conta_usuario_id",
        primary_key=True)
    conta = models.ForeignKey(
        'plataforma.Conta',
        db_column="conta_id",
        related_name="conta_usuarios",
        on_delete=models.CASCADE)
    usuario = models.ForeignKey(
        'plataforma.Usuario',
        db_column="usuario_id",
        related_name="contas_usuario",
        on_delete=models.CASCADE)
    administrador = models.BooleanField(
        db_column="conta_usuario_administrador",
        default=False)
    contrato = models.ForeignKey(
        'plataforma.Contrato',
        related_name="contas_usuarios")
...
class ContaUsuarioConvite(models.Model):
    ...
    id = custom_models.BigAutoField(
        db_column="conta_usuario_convite_id",
        primary_key=True)
    email = models.EmailField(db_column="conta_usuario_convite_email")
    chave = models.CharField(
        db_column="conta_usuario_convite_chave",
        max_length=64)
    data_criacao = models.DateTimeField(
        db_column="conta_usuario_convite_data_criacao",
        auto_now_add=True)
    ...
    def convidar_usuario(cls, request, conta, email=None, usuario=None):
        ...
        url_aceitar_convite = reverse(
            'public_convite_aceitar',
            args=[
                convite.chave])
        url_recusar_convite = reverse(
            'public_convite_recusar',
            args=[
                convite.chave])
...
class Observacao(models.Model):
    ...
    usuario = models.ForeignKey(
        ...
        on_delete=models.CASCADE)
    encaminhada = models.BooleanField(
        db_column="observacao_encaminhada",
        default=False)
    data_criacao = models.DateTimeField(
        db_column='observacao_data_criacao',
        auto_now_add=True)
    conta = models.ForeignKey(
        'plataforma.Conta',
        db_column="conta_id",
...
class Parceiro(models.Model):
    ...
    nome = models.CharField(
        db_column='parceiro_nome',
        max_length=128,
        unique=True)
    nome_responsavel = models.CharField(
        db_column='parceiro_nome_responsavel',
        max_length=128,
        unique=True)
    categoria = models.CharField(
        max_length=64,
        db_column='parceiro_categoria',
        null=False,
        choices=CATEGORIAS_PARCEIRO)
    ativo = models.BooleanField(db_column="parceiro_ativo", default=False)
    data_contrato = models.DateField(
        db_column="parceiro_data_contrato",
        null=True)
    url = models.CharField(
        max_length=256,
        db_column="parceiro_url",
        null=False)
    logo = models.CharField(
        max_length=256,
        db_column="parceiro_logo",
        null=False)
    descricao = models.TextField(db_column="parceiro_descricao", null=True)
    telefone = models.CharField(
        u'Telefone principal',
        db_column="parceiro_telefone",
        max_length=11,
        null=True,
        default=None)
...
class EmailTemplate(models.Model):
    ...
    codigo = models.CharField(
        db_column='email_template_codigo',
        max_length=256)
    descricao = models.TextField(
        db_column='email_template_descricao',
        null=True)
    assunto = models.CharField(
        db_column='email_template_assunto',
        max_length=512,
        null=False)
    conteudo_html = models.TextField(
        db_column='email_template_conteudo_html',
        null=False)
    conteudo_txt = models.TextField(
        db_column='email_template_conteudo_txt',
        null=True)

    de = models.CharField(
        db_column="email_template_de",
        max_length=256,
        null=False,
        choices=EMAIL_ENVIO)
    ...
    para = models.CharField(
        db_column="email_template_para",
        max_length=256,
        null=False,
        choices=EMAIL_ENVIO)
    responder_para = models.CharField(
        db_column="email_template_responder_para",
        max_length=256,
        null=True,
        choices=EMAIL_ENVIO)

    data_criacao = models.DateTimeField(
        db_column="email_template_data_criacao",
        auto_now_add=True)
    data_modificacao = models.DateTimeField(
        db_column="email_template_data_modificacao",
        auto_now=True)

    contrato = models.ForeignKey(
        'plataforma.Contrato',
        related_name="emails_templates",
        null=True,
        default=1)
...
class Contrato(models.Model):
    ...
    VENCIMENTOS = [(None, u' - Vazio - ')] + [(x, u'Dia %s' % x)
                                              for x in range(1, 29)]
    TIPO_PESSOA = [
        ("PF", u"Pessoa Física"),
        ("PJ", u"Pessoa Jurídica")
    ...
    ativo = models.BooleanField(
        u'Ativo?',
        db_column="contrato_ativo",
        default=True)

    data_inicio = models.DateField(
        u'Data de início do contrato',
        db_column='contrato_data_inicio')
    validade_meses = models.IntegerField(
        u'Tempora de validade',
        db_column='contrato_validade_meses',
        default=12,
        choices=MESES_VALIDADE)

    colecao_id = models.IntegerField(
        u'ID da Coleção',
    ...
    tipo = models.CharField(
        u'Tipo',
        db_column="contrato_tipo",
        max_length=32,
        choices=TIPOS,
        default=TIPO_REVENDA)
    dia_vencimento = models.IntegerField(
        u'Dia do vencimento da fatura',
        default=None,
        null=True,
        choices=VENCIMENTOS,
        db_column='contrato_dia_vencimento',
        blank=True)
    cadastro_restrito = models.BooleanField(
        u'Cadastro restrito pelo administrador?',
        db_column="contrato_cadastro_restrito",
        default=False)
    ...
    endereco_cep = models.CharField(
        ...
        null=True,
        default=None,
        help_text=u'Somente números.')
    endereco_cidade = models.CharField(
        u'Cidade',
        db_column="contrato_endereco_cidade",
        max_length=50,
        null=True,
        default=None)
    endereco_cidade_ibge = models.IntegerField(
        u'Código da cidade no IBGE',
    ...
    nome = models.CharField(
        u'Nome da plataforma',
        db_column="contrato_nome",
        max_length=255)
    codigo = models.CharField(
        u'Código interno',
        db_column="contrato_codigo",
        max_length=255,
        help_text=u'Exemplo: plataforma-exemplo',
        unique=True)
    dominio = models.CharField(
        u'Domínio',
        db_column="contrato_dominio",
        max_length=255)
    url_institucional = models.CharField(
        u'Site institucional',
        db_column="contrato_url_institucional",
        max_length=255)

    url_termo = models.CharField(
        u'URL Termo de uso',
    ...
    parametros = JSONField(
        ...
        null=True,
        help_text=u'Os parametros informados vão sobreescrever os do contrato principal.')
    ...
    chave = UUIDField(db_column="contrato_chave")

    html = models.TextField(
        u'Código HTML',
        db_column='contrato_html',
        default=None,
        null=True,
        blank=True)
...
class Index(models.Model):
    ...
    status = models.IntegerField(
        db_column='index_status',
        default=1,
        null=False)
    data_atualizacao = models.DateTimeField(
        db_column='index_data_atualizacao',
        auto_now=True)
    ...
    categoria_global = models.ForeignKey(
        'catalogo.CategoriaGlobal',
        db_column='cateogria_global_id')
