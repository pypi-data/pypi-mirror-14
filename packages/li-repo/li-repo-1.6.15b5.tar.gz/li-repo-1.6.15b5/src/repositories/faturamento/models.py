...
#     forma_pagamento = models.CharField(db_column="dados_cobranca_forma_pagamento", max_length=255)
#     tipo_pessoa = models.CharField(db_column="dados_cobranca_tipo_pessoa", max_length=255)
#     email_nfe = models.CharField(db_column="dados_cobranca_email_nfe", max_length=255)
#     nome_responsavel = models.CharField(db_column="dados_cobranca_nome_responsavel", max_length=255)
#     cpf = models.CharField(db_column="dados_cobranca_cpf", max_length=30)
#     razao_social = models.CharField(db_column="dados_cobranca_razao_social", max_length=255)
#     cnpj = models.CharField(db_column="dados_cobranca_cnpj", max_length=23)
#     telefone_principal = models.CharField(db_column="dados_cobranca_telefone_principal", max_length=255)
#     telefone_alternativo = models.CharField(db_column="dados_cobranca_telefone_alternativo", max_length=255)
#     endereco_logradouro = models.CharField(db_column="dados_cobranca_endereco_logradouro", max_length=255)
#     endereco_numero = models.CharField(db_column="dados_cobranca_endereco_numero", max_length=255)
#     endereco_complemento = models.CharField(db_column="dados_cobranca_endereco_complemento", max_length=255)
#     endereco_bairro = models.CharField(db_column="dados_cobranca_endereco_bairro", max_length=255)
#     endereco_cidade_ibge = models.CharField(db_column="dados_cobranca_endereco_cidade_ibge", max_length=255)
#     endereco_estado = models.CharField(db_column="dados_cobranca_endereco_estado", max_length=255)
#     endereco_cep = models.CharField(db_column="dados_cobranca_endereco_cep", max_length=255)
#
#     objects = MyObjects()
#
...
#
#     class Meta:
#         # app_label = "repositories_faturamento"
...
#     nome_portador = models.CharField(db_column="dados_cobranca_cartao_nome_portador", max_length=255)
...
#     situacao = models.CharField(db_column="fatura_situacao",max_length=255)
...
#     dados_forma_pagamento = models.CharField(db_column="fatura_dados_forma_pagamento", choices=FORMAS_DE_PAGAMENTO, max_length=255)
#     dados_tipo_pessoa = models.CharField(db_column="fatura_dados_tipo_pessoa", max_length=255)
#     dados_email_nfe = models.CharField(db_column="fatura_dados_email_nfe", max_length=255)
#     dados_nome_responsavel = models.CharField(db_column="fatura_dados_nome_responsavel", max_length=255)
#     dados_cpf = models.CharField(db_column="fatura_dados_cpf", default=None, max_length=255)
#     dados_razao_social = models.CharField(db_column="fatura_dados_razao_social", default=None, max_length=255)
#     dados_cnpj = models.CharField(db_column="fatura_dados_cnpj", default=None, max_length=255)
#     dados_telefone_principal = models.CharField(db_column="fatura_dados_telefone_principal", default=None, max_length=255)
#     dados_telefone_alternativo = models.CharField(db_column="fatura_dados_telefone_alternativo", default=None, max_length=255)
#     dados_endereco_logradouro = models.CharField(db_column="fatura_dados_endereco_logradouro", max_length=255)
#     dados_endereco_numero = models.CharField(db_column="fatura_dados_endereco_numero", max_length=255)
#     dados_endereco_complemento = models.CharField(db_column="fatura_dados_endereco_complemento", default=None, max_length=255)
#     dados_endereco_bairro = models.CharField(db_column="fatura_dados_endereco_bairro", max_length=255)
#     dados_endereco_cidade_ibge = models.CharField(db_column="fatura_dados_endereco_cidade_ibge", max_length=255)
#     dados_endereco_estado = models.CharField(db_column="fatura_dados_endereco_estado", max_length=255)
#     dados_endereco_cep = models.CharField(db_column="fatura_dados_endereco_cep", max_length=255)
#     boleto_codigo_de_barras = models.CharField(db_column="fatura_boleto_codigo_de_barras", default=None, max_length=255)
#     boleto_url = models.CharField(db_column="fatura_boleto_url", default=None, max_length=255)
#     cartao_de_credito_cv = models.CharField(db_column="fatura_cartao_de_credito_cv", default=None, max_length=255)
#     cartao_de_credito_numero = models.CharField(db_column="fatura_cartao_de_credito_numero", default=None, max_length=255)
#     cartao_de_credito_msgret = models.CharField(db_column="fatura_cartao_de_credito_msgret", default=None, max_length=255)
#     cartao_de_credito_codret = models.CharField(db_column="fatura_cartao_de_credito_codret", default=None, max_length=255)
#     cartao_de_credito_data_autorizacao = models.DateField(db_column="fatura_cartao_de_credito_data_autorizacao", default=None)
#     controle_lancamento_numero = models.TextField(db_column="fatura_controle_lancamento_numero", default=None)
...
#     referencia_tabela = models.CharField(db_column="fatura_item_referencia_tabela", null=True, default=None, max_length=255)
#     referencia_campo = models.CharField(db_column="fatura_item_referencia_campo", null=True, default=None, max_length=255)
#     referencia_id = models.IntegerField(db_column="fatura_item_referencia_id", null=True, default=None)
#     referencia_situacao_principal = models.CharField(db_column="fatura_item_referencia_situacao_principal", null=True, default=None, max_length=255)
#     referencia_situacao_complementar = models.CharField(db_column="fatura_item_referencia_situacao_complementar", null=True, default=None, max_length=255)
...
#     valor = models.DecimalField(db_column="plano_valor", decimal_places=2, max_digits=16)
...
#     valor = models.DecimalField(db_column="tema_valor", max_digits=12, decimal_places=2)
#
...
"""
#########################################################################################################
                        abaixo faturamento/models.py que estava em LI-AppPainel
#########################################################################################################
"""
# -*- coding: utf-8 -*-
...
class DadosCobranca(models.Model):
    ...
    cpf = models.TextField(db_column="dados_cobranca_cpf")
    razao_social = models.TextField(db_column="dados_cobranca_razao_social")
    cnpj = models.TextField(db_column="dados_cobranca_cnpj")
    telefone_principal = models.TextField(db_column="dados_cobranca_telefone_principal")
