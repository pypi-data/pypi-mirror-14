...
1. Install CO2MPAS executable internally into your python-environment with
   ...
   .. code-block:: console
        ...
        Successfully installed co2mpas-1.1.1.post1
...
2. Check that when you run ``co2mpas``, the version executed is indeed the one
   ...
   .. code-block:: console
       ...
       > co2mpas -vV
       co2mpas_version: 1.1.1.post1
       co2mpas_rel_date: 2016-03-03 16:49:00
...
3. Open the template excel-file to fill-in your vehicle data
   ...
   .. Tip::
       ...
       <http://files.co2mpas.io/CO2MPAS-1.1.1.post1/co2mpas_tutorial_1_1_0.xls>`_
...
.. tip::
    ...
    http://files.co2mpas.io/CO2MPAS-1.1.1.post1/CO2MPAS_out_template.xlsx
