...
class BotChat(object):
    ...
    def sendImage(self, image, caption=None, markup=None, format="jpeg"):
...
class BotServer(object):
    ...
    def registerChat(self, message):
        try:
            ...
            if message.left_chat_participant:
                chat.unregisterUser(message.left_chat_participant.id)
    ...
    def sendImage(self, chatid, image, caption=None, markup=None, format="jpeg"):
        try:
            if image:
    ...
    def sendImageToChatSlot(self, slot, image, caption=None, markup=None, format="jpeg"):
        try:
            chats=self.getChatsConnectedToSlot(slot)
            for chat in chats:
    ...
    def replyImage(self, message, image, caption=None, markup=None, format="jpeg"):
        try:
