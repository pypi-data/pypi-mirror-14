...
class CameraFile(object):
    ...
    def get_name(self, name: 'char const **') -> "void":
        """
        get_name(self, name)
        ...
        """
        return _file.CameraFile_get_name(self, name)
    ...
    def get_mime_type(self, mime_type: 'char const **') -> "void":
        """
        ...
        """
        return _file.CameraFile_get_mime_type(self, mime_type)
    ...
    def get_mtime(self, mtime: 'time_t *') -> "void":
        """
        ...
        """
        return _file.CameraFile_get_mtime(self, mtime)
    ...
    def get_name_by_type(self, basename: 'char const *', type: 'CameraFileType', newname: 'char **') -> "void":
        """
        get_name_by_type(self, basename, type, newname)
        ...
        """
        return _file.CameraFile_get_name_by_type(self, basename, type, newname)
    ...
    def slurp(self, data: 'char *') -> "void":
        ...
        """
        return _file.CameraFile_slurp(self, data)
...
CameraFile.slurp = new_instancemethod(_file.CameraFile_slurp, None, CameraFile)
...
def gp_file_get_name(file: 'CameraFile', name: 'char const **') -> "int":
    """
    ...
    """
    return _file.gp_file_get_name(file, name)
...
def gp_file_get_mime_type(file: 'CameraFile', mime_type: 'char const **') -> "int":
    """
    ...
    """
    return _file.gp_file_get_mime_type(file, mime_type)
...
def gp_file_get_mtime(file: 'CameraFile', mtime: 'time_t *') -> "int":
    """
    ...
    """
    return _file.gp_file_get_mtime(file, mtime)
...
def gp_file_get_name_by_type(file: 'CameraFile', basename: 'char const *', type: 'CameraFileType', newname: 'char **') -> "int":
    """
    ...
    """
    return _file.gp_file_get_name_by_type(file, basename, type, newname)
...
def gp_file_slurp(arg1: 'CameraFile', data: 'char *') -> "size_t *":
    """
    ...
    """
    return _file.gp_file_slurp(arg1, data)
