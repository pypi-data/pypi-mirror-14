...
! A circular spot on the limb in prjection is seen as an ellipse that is
...
if (verbose >= v_debug) then
  print '(a,2F10.6)','spot_limb_eclipse: xy_tng,1 = ',xy_tng(1:2,1)
  print '(a,2F10.6)','                   xy_tng,2 = ',xy_tng(1:2,2)
end if
