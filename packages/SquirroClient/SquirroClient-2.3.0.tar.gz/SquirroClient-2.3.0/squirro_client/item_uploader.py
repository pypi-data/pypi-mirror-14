...
class ItemUploader(object):
    ...
    :param bulk_index: If set to `True` the cluster is instructed to index
        data in bulk.
    :param bulk_index_migrate_item_identifier: If set to `True` the cluster
        is instructed to migrate the item identifier during bulk indexing.
    ...
    def _create_source(self, source_name, processing_config=None,
        ...
        # bulk indexing: migrate item identifier
        bulk_index_migrate_item_identifier = self.config.get(
            'bulk_index_migrate_item_identifier')
        if bulk_index_migrate_item_identifier:
            source_config['bulk_index_migrate_item_identifier'] = \
                bulk_index_migrate_item_identifier
    ...
    DEFAULTS = {
        ...
        'bulk_index': False,
        'bulk_index_migrate_item_identifier': False,
