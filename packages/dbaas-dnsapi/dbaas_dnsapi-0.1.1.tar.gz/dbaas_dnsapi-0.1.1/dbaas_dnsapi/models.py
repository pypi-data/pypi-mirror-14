...
class PlanAttr(BaseModel):
    dbaas_plan = models.ForeignKey(
        'physical.Plan', related_name="dnsapi_plan_attributes")
    dnsapi_vm_domain = models.CharField(
        verbose_name=_("VM Domain"), max_length=100)
    dnsapi_database_domain = models.CharField(
        verbose_name=_("Database Domain"), max_length=100)
    dnsapi_database_sufix = models.CharField(
        verbose_name=_("Database Sufix"), max_length=100, null=True, blank=True)
