        ...
        def stdout(self, kwargs):
            ...
            if not self.db_path:
                raise cherrypy.HTTPError(
                    501,
                    "This Sloth server doesn't have a database to store logs")

            listen_point = kwargs.get('listen_point')

            if not listen_point:
                raise cherrypy.HTTPError(400,
                                         'Missing parameter "listen_point"')
            ...
            try:
                ...
                query_params = (listen_point + '.exec',
                ...
                stdout = [dict(zip(column_names, record))
