...
prefixes, gen = get_enrichment_generator('?r a scm:Repository',
                                         '?r doap:name "sdh-ci-metrics"',
                                         '?r scm:hasBranch ?b',
                                         '?b doap:name "v2"',
                                         '?b scm:hasCommit ?c',
                                         '?c scm:commitId "513e8d4346ecfd83b5e8ad16d812c9d87bbcf38e"',
                                         '* ci:forCommit ?c',
                                         '* ci:forBranch ?b',
                                         broker_host=BROKER_HOST,
                                         agora_host=AGORA_HOST,
...
# prefixes, gen = get_enrichment_generator('?o org:hasProduct ?p',
#                                          '?p org:id "product-sdh-agora"',
#                                          '* org:forProduct ?p',
#                                          broker_host=BROKER_HOST,
#                                          agora_host=AGORA_HOST,
#                                          agora_port=AGORA_PORT,
