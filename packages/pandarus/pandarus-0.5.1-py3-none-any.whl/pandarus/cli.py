...
Usage:
  pandarus <map1> [--field1=<field1>|--band1=<band1>] <map2> [--field2=<field2>|--band2=<band2>] <output> [csv|json|pickle] [options]
  pandarus areas <map> [--field=<field>|--band=<band>] <output> [csv|json|pickle] [options]
...
def main():
    arguments = docopt(__doc__, version='Pandarus CLI 0.2')
    # if arguments['info']:
