...
class orthpolxx_install(install):
    ...
    def run(self):
        ...
        error = os.system("pip install numpy")
        if error: raise Exception("numpy compile error")
...
# class orthpolxx_clean(clean):

#     def run(self):
#         print("Cleaning ORTHPOLxx")
#         os.chdir("./ORTHPOLxx")
#         error = os.system("make clean")
#         if error: raise Exception("Compile error of ORTHPOLxx")
#         os.chdir("../")
#         super(orthpolxx_clean,self).run()
