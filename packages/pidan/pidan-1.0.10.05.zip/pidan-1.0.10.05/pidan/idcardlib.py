...
def is_valid_chinese_idcard(idcard,allow_15=True):
...
if __name__ == '__main__':
    print(is_valid_chinese_idcard('421022197902180311'))
    print(u'birthday:' ,get_birthday_from_chinese_idcard('37020219830314142x'))
    print(u'gender:',get_gender_from_chinese_idcard('37020219830314142X'))