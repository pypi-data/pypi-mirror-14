...
from bidon.util import local_now, utc_now
...
class ModelAccess(DataAccess):
  ...
  Provides methods for CRUDing objects derived from bidon.data.ModelBase.
  """
  ...
  def insert_model(self, model):
    ...
    returning = ", ".join(returnings)
    cr = self.insert(model.table_name, data, returning=returning)
  ...
  def find_or_create(self, constructor, props):
