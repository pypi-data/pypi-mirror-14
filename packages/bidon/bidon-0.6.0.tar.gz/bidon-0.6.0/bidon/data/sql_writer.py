...
class SQLWriter(object):
  ...
  def join_comparisons(self, values, joiner, is_assignment=False):
    ...
    if isinstance(values, str):
      ...
      return joiner.join(self.value_comparisons(values, "=", is_assignment))

  def parse_constraints(self, constraints, joiner=" and ", is_assignment=False):
    ...
    if constraints is None:
      ...
      return (
        self.join_comparisons(constraints, joiner, is_assignment),
