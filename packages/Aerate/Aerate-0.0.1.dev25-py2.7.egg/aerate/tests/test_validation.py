...
class TestValidation(TestBase):
           ...
           "properties": {
                "alarm": {
                   ...
                   "properties": {
                      "rain": {
                         "type": "boolean",
                         "description": "Turning on or off rain alarms; true = on, false = off"
                      }
                   }
                }
           }
    ...
    def test_validate_object_subobject(self):
        """ Test that a sub object dict passes"""
        self.assertTrue(validate_object(self.objschema, self.subobject))
