...
class NamespacesOperations(object):
    ...
    def get_long_running_operation_status(
        ...
        :param operation_status_link: Location value returned by the Begin
         operation.
        ...
        if response.status_code not in [404, 202, 200]:
            exp = CloudError(response)
            exp.request_id = response.headers.get('x-ms-request-id')
            raise exp
