...
SWIGINTERN int gsl_sum_levin_u_workspace_minmax(gsl_sum_levin_u_workspace *self,double const *array,size_t const n,size_t const min_terms,size_t const max_terms,double *sum_accel,double *abserr){
...
SWIGINTERN int gsl_sum_levin_utrunc_workspace_minmax(gsl_sum_levin_utrunc_workspace *self,double const *array,size_t const n,size_t const min_terms,size_t const max_terms,double *sum_accel,double *abserr){
...
SWIGINTERN PyObject *_wrap__levin_minmax(PyObject *SWIGUNUSEDPARM(self), PyObject *args, PyObject *kwargs) {
  ...
  if (!SWIG_IsOK(ecode4)) {
    SWIG_exception_fail(SWIG_ArgError(ecode4), "in method '" "_levin_minmax" "', argument " "4"" of type '" "size_t""'");
  } 
  arg4 = (size_t)(val4);
  ecode5 = SWIG_AsVal_size_t(obj3, &val5);
  if (!SWIG_IsOK(ecode5)) {
    SWIG_exception_fail(SWIG_ArgError(ecode5), "in method '" "_levin_minmax" "', argument " "5"" of type '" "size_t""'");
  } 
  arg5 = (size_t)(val5);
  result = (int)gsl_sum_levin_u_workspace_minmax(arg1,(double const *)arg2,arg3,arg4,arg5,arg6,arg7);
  {
    /* 
          * assert(result >= 0);  assertion removed as PyGSL_error_flag can deal with
          *	negative numbers.
...
SWIGINTERN PyObject *_wrap__levin_utrunc_minmax(PyObject *SWIGUNUSEDPARM(self), PyObject *args, PyObject *kwargs) {
  ...
  ecode4 = SWIG_AsVal_size_t(obj2, &val4);
  if (!SWIG_IsOK(ecode4)) {
    SWIG_exception_fail(SWIG_ArgError(ecode4), "in method '" "_levin_utrunc_minmax" "', argument " "4"" of type '" "size_t""'");
  } 
  arg4 = (size_t)(val4);
  ecode5 = SWIG_AsVal_size_t(obj3, &val5);
  if (!SWIG_IsOK(ecode5)) {
    SWIG_exception_fail(SWIG_ArgError(ecode5), "in method '" "_levin_utrunc_minmax" "', argument " "5"" of type '" "size_t""'");
  } 
  arg5 = (size_t)(val5);
  result = (int)gsl_sum_levin_utrunc_workspace_minmax(arg1,(double const *)arg2,arg3,arg4,arg5,arg6,arg7);
  {
    /* 
          * assert(result >= 0);  assertion removed as PyGSL_error_flag can deal with
          *	negative numbers.
