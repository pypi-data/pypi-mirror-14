...
# Auto-generated file for API static documentation stubs (2016-03-31T16:14:25.829179)
#
# **DO NOT EDIT**
...
class _DocStubsEdgeFrame(object):
    ...
    @doc_stub
    def aggregate_with_udf(self, aggregate_by_column_keys, column_names, column_types, udf):
        """
        Combine by key current frame.

        Combines data of frame based on key by evaluating a function for each row.

        :param aggregate_by_column_keys: list of column key(s) to aggregate on
        :type aggregate_by_column_keys: list
        :param column_names: List of names for the new columns
        :type column_names: list
        :param column_types: List of data types for the new columns
        :type column_types: list
        :param udf: 
        :type udf: None
    ...
    @doc_stub
    def daal_pca(self, column_names, method='cor'):
        """
        Calculate principal components using Intel's Data Analytics Acceleration Library (DAAL).

        Principal component analysis (PCA) [1]_ is used to transform a set of possibly correlated
        ...
        :param column_names: The names of the column from which to compute PCA.
        :type column_names: list
        :param method: (default=cor)  PCA method.
                                       | cor - correlation.
    ...
    @doc_stub
    def export_to_jdbc(self, table_name, connector_type=None, driver_name=None, query=None):
        """
    ...
    def flatten_column(self, column, delimiter=None):
        ...
        :param column: The name of the column to be flattened.
        :type column: str
        :param delimiter: (default=None)  The delimiter string for the column to flatten. The default is to use a ',' delimiter.
        :type delimiter: str
        """
        return None
    ...
    @doc_stub
    def invert_matrix(self, column_names):
        """
        Inverts a matrix.
        ...
        :param column_names: The list of columns of the matrix to be inverted.
        :type column_names: list
    ...
    @doc_stub
    def unflatten_column(self, columns, delimiter=None):
        """
        ...
        :type columns: str
        :param delimiter: (default=None)  Separator for the data in the result columns. Default is comma (,).
        :type delimiter: str
        """
        return None
...
class _DocStubsFrame(object):
    ...
    def helloworld(self, msg=None):
        ...
        :param msg: (default=None)  Optional message to display.
        :type msg: unicode
...
class _DocStubsGraph(object):
    ...
    def __init__(self, name=None):
        ...
        datetime.datetime(2016, 3, 31, 16, 14, 22, 163379)
