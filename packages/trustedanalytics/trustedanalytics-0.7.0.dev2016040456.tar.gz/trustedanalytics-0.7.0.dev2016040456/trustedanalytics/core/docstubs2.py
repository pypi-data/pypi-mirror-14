...
# Auto-generated file for API static documentation stubs (2016-04-04T11:48:05.796348)
#
# **DO NOT EDIT**
...
class ArimaModel(object):
    ...
    @doc_stub
    def predict(self, timeseries_values, future_periods):
        """
        ...
        :param timeseries_values: Time series values to use as the gold standard.
    ...
    def train(self, timeseries_values, p, d, q, include_intercept=True, method='css-cgd', user_init_params=None):
        ...
        :param method: (default=css-cgd)  Objective function and optimization method.  Current options are: 'css-bobyqa'
        ...
        :type method: unicode
        :param user_init_params: (default=None)  A set of user provided initial parameters for optimization. If the list
...
class GmmModel(object):
    ...
    @doc_stub
    def train(self, frame, observation_columns, column_scalings, k=2, max_iterations=100, convergence_tol=0.01, seed=4433268683487127699):
        """
        ...
        :param seed: (default=4433268683487127699)  Random seed
        :type seed: int64
...
class RandomForestClassifierModel(object):
    ...
    @doc_stub
    def train(self, frame, label_column, observation_columns, num_classes=2, num_trees=1, impurity='gini', max_depth=4, max_bins=100, seed=247406992, categorical_features_info=None, feature_subset_category=None):
        """
        ...
        :type max_bins: int32
        :param seed: (default=247406992)  Random seed for bootstrapping and choosing feature subsets. Default is a randomly chosen seed.
        :type seed: int32
...
class RandomForestRegressorModel(object):
    ...
    @doc_stub
    def train(self, frame, value_column, observation_columns, num_trees=1, impurity='variance', max_depth=4, max_bins=100, seed=-2089311944, categorical_features_info=None, feature_subset_category=None):
        """
        ...
        :param max_bins: (default=100)  Maximum number of bins used for splitting features. Default is 100.
        :type max_bins: int32
        :param seed: (default=-2089311944)  Random seed for bootstrapping and choosing feature subsets. Default is a randomly chosen seed.
        :type seed: int32
        :param categorical_features_info: (default=None)  Arity of categorical features. Entry (n-> k) indicates that feature 'n' is categorical with 'k' categories indexed from 0:{0,1,...,k-1}
        :type categorical_features_info: dict
