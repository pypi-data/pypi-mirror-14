...
class RetrieveCookie:
    ...
    def get_cookie(self, username, password):
        ...
        if ret.status_code != 200:
            print 'Server Status Code: {}'.format(ret.status_code)
    ...
    def uploadqkview(self, case_num, qkview_path):
        ...
        if ret.status_code == 303 and "Location" in ret.headers:
            ...
            print \
                ...
                'https://ihealth.f5.com/qkview-analyzer/qv/{}'.format(hash_id)
            self.logger.info('qkview uploaded.')
        else:
            print 'qkview uploading failed. Server status code: {}'.format(
                ret.status_code)
        return ret.content
