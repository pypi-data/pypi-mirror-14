...
setup(
    ...
    version=version,
    description="A fork of django-pagination to adapt it to django1.9",
    ...
    maintainer='Alex Kreimer',
    maintainer_email='alex.kreimer@gmail.com',
    url='https://github.com/alexkreimer/django-pagination/',
    license='BSD',
