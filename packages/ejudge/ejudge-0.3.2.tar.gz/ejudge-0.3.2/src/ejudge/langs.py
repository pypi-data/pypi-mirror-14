...
class LanguageManager(metaclass=LanguageMeta):
    ...
    def run(self, inputs, *, timeout=None, context=None):
        ...
        try:
            ...
            return remove_trailing_newline(iotypes.ErrorTestCase.exception(
                data=self.flush_io(),
...
class IntegratedLanguage(LanguageManager):
    ...
    def run(self, inputs, **kwds):
        ...
        try:
            ...
            if result is None:
                result = iotypes.IoTestCase(self.observer.flush())
        finally:
            builtins.restore()
        ...
        try:
            ...
            while inputs:
                ...
                try:
                    ...
                    inputs.append(inpt)
                    return iotypes.ErrorTestCase.exception(list(result))
                append_non_empty_out()
        finally:
            os.chdir(currpath)
