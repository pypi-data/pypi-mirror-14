...
class BuildWorkflow(object):
    ...
    def add_transition(self, prestate, condition, poststate, preconditions=None):
        """
...
class BuildTask(object):
    ...
    def __init__(self, workflow_object, created_by, task):
        ...
        new_task = Task.objects.update_or_create(created_by = created_by, workflow_id = workflow_obj[0], title = task)
        print new_task
    ...
    def create_task(self, workflow_obj, created_by, task):
        """
        Function to create a new task
        """
        new_task = Task(created_by = created_by, workflow_id = workflow_obj.workflow_id, title = task)
        new_task.save()
...
def visualflow(approval_workflow):
