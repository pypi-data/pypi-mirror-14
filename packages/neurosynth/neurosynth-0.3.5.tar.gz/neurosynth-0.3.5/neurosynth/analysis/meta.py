...
class MetaAnalysis(object):
    ...
    def __init__(self, dataset, ids, ids2=None, q=0.01, prior=0.5,
        ...
        # Also threshold pFgA maps
        pFgA_FDR = imageutils.threshold_img(
            pFgA, fdr_thresh, p_vals, mask_out='above')
        pFgA_prior_FDR = imageutils.threshold_img(
            pFgA_prior, fdr_thresh, p_vals, mask_out='above')
