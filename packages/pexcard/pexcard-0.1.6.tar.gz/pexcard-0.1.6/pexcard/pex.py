...
API_BASE_URL = 'https://coreapi.pexcard.com/api/v4/{endpoint}'
SANDBOX_BASE_URL = 'https://corebeta.pexcard.com/api/v4/{endpoint}'
CARD_REQUEST_TEMPLATE = {"Phone", "ShippingPhone", "ShippingMethod",
                         "DateOfBirth", "Email", "ProfileAddress",
                         "ShippingAddress"}
