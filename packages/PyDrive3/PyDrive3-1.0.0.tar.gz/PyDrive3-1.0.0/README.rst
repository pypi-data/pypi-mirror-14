Fork
----
This is simply a fork of the PyDrive repo. The code here comes directly from github. But this package has not been updated on pypi for a very long time, so this is just me uploading the new one to pypi so I can use it.
This version should be PY3 compatible, so that is why I called this one py3.

If you are the owner of pydrive please contact me at nick at humrich dot us once you have uploaded the real thing, and I will remove this package.
