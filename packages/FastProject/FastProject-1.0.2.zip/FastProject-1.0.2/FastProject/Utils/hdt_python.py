...
"""
Sourced from https://github.com/tatome/dip_test
About 15 times faster than the original python implementation.
However, has a problem when unique inputs are not handled correctly!
"""
