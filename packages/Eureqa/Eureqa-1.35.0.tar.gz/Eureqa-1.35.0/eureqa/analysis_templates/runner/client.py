...
def main(argv):
    ...
    Mostly a wrapper around `eureqa.analysis_templates.runner.analysis_template_runner.
    ...
    parser = argparse.ArgumentParser(
        ...
        python -m run_analysis_template example_module
        You will be prompted for username and password if necessary.

        To run within a particular Eureqa Organization:
        python -m run_analysis_template -u <username> -p <password> -o <organization> example_module
        """))
