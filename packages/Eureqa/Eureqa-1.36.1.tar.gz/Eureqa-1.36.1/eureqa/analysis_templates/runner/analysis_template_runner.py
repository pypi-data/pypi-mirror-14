...
class analysis_template_runner:
    ...
    def get_analysis_module_from_template(self, eureqa, template):
        ...
        zipfile = os.path.join(self.tempdir, "analysis_module.zip")
        main_module_name = template.get_module(zipfile)
        self._add_to_python_path(zipfile);
        import importlib
    ...
    def run_args(self, arguments, _local_execution_parameters=None):
        ...
        if (args.analysis_template_id):
            ...
            template_execution = template.get_execution(args.execution_id)
