...
__date__    = '2016-April-4'
__url__     = 'https://engineering.purdue.edu/kak/distDT/DecisionTree-3.4.0.html'
...
CONSTRUCTING REGRESSION TREES:
    ...
    when one is trying to understanding all of the associational
    ...
    variable, specifying the degree of the polynomial is often a tricky
    business. Additionally, a polynomial can inject continuities between
    the predictor and the predicted variables that may not really exist in
    the real data.  Regression trees, on the other hand, give you a
    piecewise linear relationship between the predictor and the predicted
    variables that is freed from the constraints of superimposed
    continuities at the joins between the different segments.  See the
    following tutorial for further information regarding the standard
    linear regression approach and the regression that can be achieved with
    the RegressionTree class in this module:
...
@tag2
    construct_regression_tree()
        ...
        As the name implies, this method actually construct a regression
        tree.
...
@endcode 
        ...
        One of the keys is called 'solution_path' and the other is called
...
THE ExamplesRegression DIRECTORY:
    ...
    shows example scripts that you can use to become familiar with the
    ...
    following Python scripts without changing them and seeing what sort of
    output is produced by them:
...
@endcode
    ...
    This 'regression4.py' script involves only one predictor variable and
    ...
    script except for the fact that the training data in the file
    'gendata5.csv' consists of three noisy segments, as opposed to just two
...
ABOUT THE AUTHOR:
    ...
    The author, Avinash Kak, recently finished a 17-years long "Objects
