...
class CombinedBankApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        config.api_client = ApiClient(host="http://bank.dev.api.token.io")
        self.api_client = config.api_client

    def create_subscription_route(self, access_id, request, **kwargs):
        """
        Create subscription
        Create a subscription for a topic based on a selector to an endpoint.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_subscription_route(access_id, request, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method create_subscription_route" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('access_id' not in params) or (params['access_id'] is None):
            raise ValueError("Missing the required parameter `access_id` when calling `create_subscription_route`")
        # verify the required parameter 'request' is set
        if ('request' not in params) or (params['request'] is None):
            raise ValueError("Missing the required parameter `request` when calling `create_subscription_route`")

        resource_path = '/accesses/{accessId}/subscriptions'.replace('{format}', 'json')
        path_params = {}
    ...
    def create_transfer_route(self, access_id, request, **kwargs):
        """
        Create transfer
        Create a money transfer for a payment using the protocol designated for the account.
    ...
    def get_subscriptions_route(self, access_id, **kwargs):
        """
        Get subscriptions
        Get subscriptions on accessible account.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_subscriptions_route(access_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_subscriptions_route" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'access_id' is set
        if ('access_id' not in params) or (params['access_id'] is None):
            raise ValueError("Missing the required parameter `access_id` when calling `get_subscriptions_route`")
    ...
    def verify_access_route(self, access_id, request, **kwargs):
        """
        Verify access
        Verify access for a provider with request signed using the single use verification private key.
    ...
    def create_access_route(self, client_id, account_id, request, **kwargs):
        """
        Create unverified access
        Create an unverified access with single use verification public key.
