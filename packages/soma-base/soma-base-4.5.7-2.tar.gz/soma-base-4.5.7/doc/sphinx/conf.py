...
version = '.'.join([str(soma.info.version_major),
                    str(soma.info.version_minor)])
# The full version, including alpha/beta/rc tags.
release = '.'.join([str(soma.info.version_major),
                    str(soma.info.version_minor),
...
# html_sidebars = { '**' : ['sidelinks.html', 'localtoc.html', 'relations.html',  'sourcelink.html', 'searchbox.html' ], }

# Additional templates that should be rendered to pages, maps page names to
# template names.
# html_additional_pages = { 'toolbar' : 'toolbar.html' }
...
extlinks = {
  ...
  'axon' : ('../build-stable-release/share/doc/axon-' + version + '/%s',
    'axon '),
  'anatomist': ('../build-stable-release/share/doc/anatomist-' + version + '/%s',
    'anatomist '),
