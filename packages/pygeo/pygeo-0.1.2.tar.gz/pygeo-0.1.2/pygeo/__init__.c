...
#define __PYX_HAVE__pygeo____init__
#define __PYX_HAVE_API__pygeo____init__
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from 'pygeo.__init__' */
#define __Pyx_MODULE_NAME "pygeo.__init__"
int __pyx_module_is_main_pygeo____init__ = 0;

/* Implementation of 'pygeo.__init__' */
static char __pyx_k_main[] = "__main__";
static char __pyx_k_test[] = "__test__";
static char __pyx_k_pygeo[] = "pygeo";
static char __pyx_k_module_pygeo_platform_Unix_syno[] = "\n.. module:: pygeo\n  :platform: Unix\n  :synopsis: A distribution of tools for managing geophysical data.\n\n.. moduleauthor:: Brendan Smithyman <brendan@bitsmithy.net>\n\n";
static PyObject *__pyx_n_s_main;
static PyObject *__pyx_n_u_pygeo;
...
static struct PyModuleDef __pyx_moduledef = {
  ...
  #endif
    "pygeo",
    __pyx_k_module_pygeo_platform_Unix_syno, /* m_doc */
    -1, /* m_size */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_u_pygeo, __pyx_k_pygeo, sizeof(__pyx_k_pygeo), 0, 1, 0, 1},
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initpygeo(void); /*proto*/
PyMODINIT_FUNC initpygeo(void)
#else
PyMODINIT_FUNC PyInit_pygeo(void); /*proto*/
PyMODINIT_FUNC PyInit_pygeo(void)
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_pygeo(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("pygeo", __pyx_methods, __pyx_k_module_pygeo_platform_Unix_syno, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_pygeo____init__) {
  ...
  if (unlikely(__Pyx_SetPackagePathFromImportLib(NULL, __pyx_n_u_pygeo) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 2; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "pygeo")) {
      if (unlikely(PyDict_SetItemString(modules, "pygeo", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 2; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pygeo.__init__", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pygeo.__init__");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
