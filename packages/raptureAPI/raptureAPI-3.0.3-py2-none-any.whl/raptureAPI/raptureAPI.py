...
# Any other parameter type tweaking can also be performed here as the need arises
    ...
    def doTag_ApplyTag(self,docUri,tagUri,value):
        '''
    ...
    def doTag_ApplyTags(self,docUri,tagMap):
        '''
    ...
    def doTag_RemoveTag(self,docUri,tagUri):
        '''
        Remove a tag
        '''
        params = {}
    ...
    def doTag_RemoveTags(self,docUri,tags):
        '''
