...
class EndpointsMixin(object):
    ...
    def get_user_measurements(self, **params):
        return self.get('/users/{0}/measurements'.format(params.get('id')),
            params=params)

    def get_device_measurements(self, **params):
        return self.get('/devices/{0}/measurements'.format(params.get('id')),
            params=params)
    ...
    def get_user(self, **params):
        return self.get('/users/{0}'.format(params.get('id')),
            params=params)
    ...
    def get_device(self, **params):
        return self.get('/devices/{0}'.format(params.get('id')),
            params=params)
