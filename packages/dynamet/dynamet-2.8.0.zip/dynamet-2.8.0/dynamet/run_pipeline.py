...
###########################################################################            
 # FEATURE EXTRACTION
    ...
    @cache
    def _extract_global_features(dli_samples, t_ref, config):
        return get_global_features(dli_samples, t_ref, config)
########################################################################     
# FEATURE PROCESSING
    @cache
    ...
    def execute_workflow(config):
        ...
        sample_features=_extract_global_features(aligned_tables, t_ref, group)
