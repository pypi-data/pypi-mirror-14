...
#def extract_global_features(tables, t_ref, config, sample_order, t0_name=None, keep_all=False):
#    sort_tables_by_sample_order(tables, sample_order)
#    add_time_order_to_tables(tables, sample_order)
#    t_ref=main_collect_and_group(tables, parameters=config)
#    return get_global_features(tables, t_ref, config, keep_all)
...
def get_global_features(tables, t_ref, parameters, keep_all=False):
