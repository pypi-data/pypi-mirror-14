...
class Database(object):
    ...
    def objects(self, support=Attack.attack_support_choices,
                protocol='btas2016', groups=Client.set_choices, cls=('attack', 'real', 'enroll', 'probe'),
        ...
        protocol = self.check_parameters_for_validity(protocol, "protocol", VALID_PROTOCOLS, ('btas2016',))
