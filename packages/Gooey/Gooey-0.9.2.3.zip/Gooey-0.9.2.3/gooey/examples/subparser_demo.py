...
def main():
  ...
  curl_parser = subs.add_parser('curl', prog="Curl Bro", help='curl is a tool to transfer data from or to a server')
  ...
  # ########################################################
  ffmpeg_parser = subs.add_parser('ffmpeg', prog='FMpFSD', help='Siege is an http/https regression testing and benchmarking utility')
