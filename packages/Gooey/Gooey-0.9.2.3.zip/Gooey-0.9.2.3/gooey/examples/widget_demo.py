...
@Gooey(dump_build_config=True, program_name="Widget Demo", group_by_type=False)
def main():
  ...
  my_cool_parser.add_argument('-j', '--jaws', help='ooop', widget="MultiFileChooser")
  ...
  my_cool_parser.add_argument("-o", "--overwrite", action="store_true", default=True, help="Overwrite output file (if present)")
