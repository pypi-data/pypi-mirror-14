...
def calc_winds(grad_wind):
    ...
    steep_inv = round(grad_wind * (1 / 6), 0)
    steep_inv_gust = steep_inv
    shallow_inv = round(grad_wind * (3 / 10), 0)
    shallow_inv_gust = round(shallow_inv * (30 / 25), 0)
    salr_sfc = round(grad_wind * (2 / 5), 0)
    salr_sfc_gust = round(salr_sfc * (35 / 25), 0)
    one_c1000 = round(grad_wind * (25 / 49), 0)
    one_c1000_gust = round(one_c1000 * (35 / 25), 0)
    dalr_sfc = round(grad_wind * (25 / 45), 0)
    dalr_sfc_gust = round(dalr_sfc * (24.5 / 15), 0)
    dalr_6000 = round(grad_wind * (30 / 49.5), 0)
    dalr_6000_gust = round(dalr_6000 * (24.5 / 15), 0)
    large_cu = round(grad_wind * (27.5 / 40), 0)
    large_cu_gust = round(large_cu * (24.5 / 15), 0)
