class portfolio_materialize:
	...
	def navbar(self):
		navbar = raw_input('navbar yes or no?')
		if navbar == 'yes':
			self.navbar = True
		elif navbar == 'no':
			self.navbar = False
	...
	def quote(self):
		...
		if quote == 'yes':
			...
			self.quote = raw_input("I had no interesting quote to provide")
		else: 
			self.quote()
