...
setup(
    ...
    url='https://github.com/Antlos/pycontextbroker',
    download_url='https://github.com/Antlos/pycontextbroker/tarball/0.1', # I'll explain this in a second
    keywords=['orion', 'context', 'broker', 'fiware'],
    classifiers=[],
)