...
class Subscription(object):
    ...
    def __init__(self, rics, fields, on_start=None, on_update=None, on_error=None, on_close=None, debug=False):
        ...
        on_start: callable object which is called when subscription is established.
            This function has no argument.
            Default: None

        on_update: callable object which is called when received data.
            Use to notify when an update was received
            This function has 1 argument: utf-8 string which we get from the server.
            Default: None

        on_error: callable object which is called when error i
            This function has 1 argument: exception object
            Default: None

        on_close: callable object which is called when subscription is closed.
            This function has no argument.
            Default: None
        ...
        --------
        >>> import eikon as ek
        >>> subscription = ek.Subscription(['VOD.L', 'EUR=', 'PEUP.PA', 'IBM.N'], ['DSPLY_NAME', 'BID', 'ASK'], on_message)
    ...
    @staticmethod
    def __on_open(ws):
        self = Subscription.__get_subscription()
    ...
    def __get_subscription(cls, subscription = None):
        ...
        return Subscription.__all_subscriptions.get(subscription_id, None)
