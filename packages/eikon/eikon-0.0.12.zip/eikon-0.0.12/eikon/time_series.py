...
def get_timeseries(rics, start_date=None, end_date=None, interval='daily', fields=None, count=None,
    ...
    if start_date is None:
        if end_date is None:
            ...
            #######################################################################################
            # WORKAROUND to avoid error from backend when both start_date & end_date not defined  #
            #    set startdate to now()                                                           #
            payload.update({'startdate': end_date})                                               #
            # end of WORKAROUND                                                                   #
            #######################################################################################
        else:
