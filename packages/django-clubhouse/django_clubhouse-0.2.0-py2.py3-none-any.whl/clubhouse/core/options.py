...
__all__ = ['BlockContextAdmin','BlockContextAdminBase','BlockAdmin','BlockInline',
        'PageAdmin']
...
class BlockContextListDisplay(object):
...
class BlockContextAdmin(six.with_metaclass(BlockContextAdminBase,BaseModelAdmin)):
    ...
    def get_list_display(self, request):
        ...
        return tuple(list(self.list_display) + [BlockContextListDisplay()])
