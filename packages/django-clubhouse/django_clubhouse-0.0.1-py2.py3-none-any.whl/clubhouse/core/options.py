...
from clubhouse.core.models import BlockTypeBase, ReusableBlock, BlockBase
from clubhouse.core.filters import BlockTypeListFilter

__all__ = ['BlockTypeAdmin','BlockTypeAdminBase','BlockAdmin','BlockInline']

DEFAULT_NAMES = ('verbose_name','verbose_name_plural','permissions','ordering',
        'default_permissions','block_type')
...
class BlockTypeAdminOptions(object):
...
class BlockTypeAdminBase(forms.MediaDefiningClass):
    """
    MetaClass for BlockAdmin
    """
    def __new__(cls, name, bases, attrs):
        super_new = super(BlockTypeAdminBase, cls).__new__
        ...
        new_class.add_to_class('_meta', BlockTypeAdminOptions(meta))
...
class BlockTypeAdmin(six.with_metaclass(BlockTypeAdminBase,BaseModelAdmin)):
    ...
    def __init__(self, block_type, admin_site):
        if not isinstance(block_type, BlockTypeBase):
            raise ImproperlyConfigured('Block type %s does not extend '
                    'clubhouse_core.BlockTypeBase' % block_type.__class__\
                            .__name__)
        ...
        super(BlockTypeAdmin,self).__init__()
    ...
    def get_list_filter(self,request):
        ...
        """
        return tuple([BlockTypeListFilter] + list(self.list_filter))
    ...
    def get_changelist(self, request, **kwargs):
        ...
        """
        from clubhouse.core.views.admin import BlockTypeChangeList
        return BlockTypeChangeList
...
class BlockInline(admin.StackedInline):
    ...
    def get_block_models(self):
        return self.block_type.get_block_models()
