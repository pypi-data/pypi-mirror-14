...
class stud_pro(Frame):
	def __init__(self, parent, controller):								#marks window 
		...
		# q = Frame(self)
		# self.l1 = l1 = Label(q,text=" Name : Kuldeep ")
		# self.l2 = l2 = Label(q,text=" Roll no : 140101034")
		# self.l3 = l3 = Label(q,text=" Total marks : 50")
		# l1.pack(side=LEFT)
		# l2.pack(side=LEFT)
		# l3.pack(side=LEFT)
		# #but1 = Button(q, text = "Assignment 1", command = lambda: self.addquestion())
		# #but2 = Button(q, text = "Assignment 2", command = lambda: self.addquestion())
		# #but1.pack(side = TOP)
		# #but2.pack(side = TOP)
		# q.pack(side = TOP)
		# q1 = Frame(self)
		# but1 = Button(q1, text = "Assignment 1", height = 1,  command = lambda: self.addquestion())
		# marks = Label(q1,text=" Marks :  50")
		# but1.pack(side = LEFT)
