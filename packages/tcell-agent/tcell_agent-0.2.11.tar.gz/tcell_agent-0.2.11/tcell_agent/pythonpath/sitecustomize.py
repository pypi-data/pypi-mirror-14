...
try:
     ...
     print("tCell.io:  Started tCell.io agent v{version} (sitecustomize)".format(version=VERSION))
except Exception as e:
    print("tCell.io: Error: Could not start tCell.io agent v{version} {e} (sitecustomize)".format(version=VERSION, e=e))
    traceback.print_exc()
