...
e. download 
f. download newest NCBI homo gene file: http://www.ncbi.nlm.nih.gov/gene/
...
b. genelist: GeneList_csv_directory (Each input cvs file must contain only one genelist, which means it only has one row!!)
