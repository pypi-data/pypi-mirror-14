...
cmd_log = Command('log',
  ...
  Examples:
      1. %s log <jobId>                                                 # print all instance logs for a job
      1. %s log <jobId> -d /path/to/save/logs/                          # download all instance logs for a job
...
cmd_submit_job = Command('submit', alias=['sub'],
  ...
  Examples:
      ...
      3. %s sub "python main.py arg1 arg2" jobName1 -c cls-xxxx -p ./my_program/
