...
from .action import project_create,project_build,project_submit,project_status,project_update,project_task_add
...
def init(cmd_project):
    ...
    cmd_project_update = Command('update',
      ...
      Examples:
          ...
          4. %s p update -d oss://your-bucket/dockers/:localhost:5000/myubuntu  # update all task use docker ''' % (
    ...
    cmd_project_update.option("-d, --docker [docker_path]", MSG['project']['update']['option']['docker'],
