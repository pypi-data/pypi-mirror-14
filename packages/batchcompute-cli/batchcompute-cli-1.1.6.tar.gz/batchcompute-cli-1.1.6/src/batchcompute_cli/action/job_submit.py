...
from ..util import client,config, formater, oss_client, list2table, result_cache, sys_config
...
def submit(cmd, cluster=DEFAULT_CLUSTER, timeout=172800, nodes=1, pack=None, env=None, read_mount={}, write_mount={}, mount=None):
    ...
    cluster = parse_cluster_cfg(cluster)
