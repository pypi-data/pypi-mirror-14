    ...
    return {
        ...
        'submit': {
            ...
            'option': {
                ...
                'mount': "mount a oss path to local file system, kv-pairs, multi-supported, format: <oss_path>:<dir_path>[,<oss_path2>:<div_path2>...], example: oss://bucket/key:/home/admin/ossdir "
