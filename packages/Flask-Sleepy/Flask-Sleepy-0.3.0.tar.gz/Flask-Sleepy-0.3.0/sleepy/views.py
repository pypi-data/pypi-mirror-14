...
from sleepy.adapter import (MarshmallowSchemaMixin, SQLAModelMixin,
                            AbstractSerializationMixin, AbstractDataModelMixin)
from sleepy.exceptions import SerializationException
...
class BaseSleepyView(MethodView, AbstractSerializationMixin, AbstractDataModelMixin):
    ...
    def get(self, obj_id=None):
        ...
        :param obj_id: The id of the object to get. If None, self.get_index is called, otherwise,
        self.get_entity(obj_id) is called.
        """
