...
# _DOC oncall [ttho]
# _DOC open [ADCAMPAIGN_CREATE_MAI_DPA]
...
campaign[Campaign.Field.name] = 'Mobile App Installs Campaign' \
    ' with Dynamic Product Ads'
campaign[Campaign.Field.objective] = Campaign.Objective.mobile_app_installs
...
# _DOC close [ADCAMPAIGN_CREATE_MAI_DPA]
