...
class TopologySummary:
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.sched_status = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 514:
        if ftype == TType.STRING:
  ...
  def write(self, oprot):
    ...
    if self.sched_status is not None:
      ...
      oprot.writeString(self.sched_status)
      oprot.writeFieldEnd()
...
class SupervisorInfo:
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.assignment_id = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 4:
        if ftype == TType.LIST:
  ...
  def write(self, oprot):
    ...
    if self.assignment_id is not None:
      ...
      oprot.writeString(self.assignment_id)
      oprot.writeFieldEnd()
...
class Assignment:
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.STRING:
          self.master_code_dir = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 2:
        if ftype == TType.MAP:
  ...
  def write(self, oprot):
    ...
    if self.master_code_dir is not None:
      ...
      oprot.writeString(self.master_code_dir)
      oprot.writeFieldEnd()
...
class ClusterWorkerHeartbeat:
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.STRING:
          self.storm_id = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 2:
        if ftype == TType.MAP:
  ...
  def write(self, oprot):
    ...
    if self.storm_id is not None:
      ...
      oprot.writeString(self.storm_id)
      oprot.writeFieldEnd()
...
class LocalAssignment:
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.STRING:
          self.topology_id = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 2:
        if ftype == TType.LIST:
  ...
  def write(self, oprot):
    ...
    if self.topology_id is not None:
      ...
      oprot.writeString(self.topology_id)
      oprot.writeFieldEnd()
    if self.executors is not None:
