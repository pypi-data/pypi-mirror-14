...
class GrasshopperEngine:
	def __init__(self,host='0.0.0.0',port=5555):
		"""
		You can define a host/port here!
		"""
		self.host = host
		self.port = port
		self.app = None
	...
	def run(self):
		...
		print "Start listen on ",self.host,"port",self.port
		while True:
			#///////////////////////////
					...
					while True:
						try:
							...
							if msg.errno == errno.EAGAIN:
								requests[fd] = datas
								responses[fd]=self.app.get_data(datas)	# For app ................
...
#---------------------------------------------------------------------------
					...
					while True:
						...
						send_length += connections[fd].send(responses[fd][send_length:])
