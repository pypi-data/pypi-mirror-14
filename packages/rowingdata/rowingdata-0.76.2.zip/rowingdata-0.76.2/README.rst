...
Big Data in fitness. As much as "big data" is a buzzword, there are
many fitness fanatics among the self-trackers. It's exciting how much 
data we have available, and we like to play and combine. For that, we
need to be able to move any data from any workout to the environment of our 
choice. 
