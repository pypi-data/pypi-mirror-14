...
class rowingdata:
    ...
    def __init__(self,readFile="testdata.csv",rower=getdefaultrower()):
	self.readFile = readFile
	self.rower = rower
...
#	df['hr_max'][df[' HRCur (bpm)']>self.rower.max] = 0
    ...
    def uploadtoc2(self,type="Indoor Rower",
	...
	if (save_user == "y" or save_pass == "y"):
	    self.rower.write("defaultrower.txt")
