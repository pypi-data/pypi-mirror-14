...
The easiest way to use rowingdata is from the command line. (However, I still have to find out how to
get the scripts directory in your path. For now, you'll have to figure that out yourself.)
...
The script will also spit out some statistics from the summary csv and copies
them to your clipboard. Fire up Notepad and paste them there.
