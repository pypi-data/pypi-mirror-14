...
#	data2 = data2.sort_values(by='t',ascending = 1)
#	data2 = data2.reindex(range(len(timestamps)))

#	timestamps = data2.ix[:,'t']
#	self.hr_values = data2.ix[:,'hr']
#	self.distance_values = data2.ix[:,'d']
#	self.spm_values = data2.ix[:,'spm']
#	self.long_values = data2.ix[:,'long']
#	self.lat_values = data2.ix[:,'lat']
	...
	#data = data.drop_duplicates(subset='TimeStamp (sec)').sort_values(by='TimeStamp (sec)',ascending = 1)
...
#	ax6.set_yticks(np.arange(1.,2.,0.05))
	...
	yrange = y_axis_range(s,ultimate=[0,4])
