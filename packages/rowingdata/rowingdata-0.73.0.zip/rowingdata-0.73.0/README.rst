...
The following will upload your row to the Concept2 logbook: ::
	...
	$ speedcoachtoc2 testdata.csv yourrower.txt datestring '04/05/16 16:15:50'

Again, yourrower.txt and date string are optional. Because the SpeedCoach CSV file content doesn't have the row date, you may provide a date string. If nothing is provided, today's date will be taken.
