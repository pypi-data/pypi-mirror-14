...
- Added plotting of ErgData (exported from Concept2 log)
...
* Add support for other erg software tools (just need the csv/tcx and it will be easy) 
  ...
  * In progress for RowPro (the parser is there but the command-line tools are missing)
  * To be Done for ergdata
