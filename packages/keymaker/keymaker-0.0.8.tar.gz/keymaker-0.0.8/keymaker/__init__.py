...
def get_authorized_keys(args):
    ...
    try:
        ...
        print("Error while retrieving IAM SSH keys for {u}: {e}".format(u=args.user, e=str(e)), file=sys.stderr)
...
def install(args):
    ...
    subprocess.check_call(["chmod", "u+x", authorized_keys_script_path])
