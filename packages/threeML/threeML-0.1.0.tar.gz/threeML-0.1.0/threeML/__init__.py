...
try:
    ...
    from c_threeML.pyModelInterface import pyToCppModelInterface

except ImportError:

    custom_warnings.warn("c_threeML is not installed. You will not be able to use plugins which require it.",
