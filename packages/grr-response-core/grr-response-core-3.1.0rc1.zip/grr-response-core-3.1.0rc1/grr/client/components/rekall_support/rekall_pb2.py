...
# source: grr/client/components/rekall_support/rekall.proto
...
_ANALYZECLIENTMEMORYARGS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='use_kcore_if_present', full_name='AnalyzeClientMemoryArgs.use_kcore_if_present', index=2,
      number=3, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=True,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\342\374\343\304\001Q\0227Use /proc/kcore if present. Only affects linux clients.\"\026Enable kcore scanning.'))),
    _descriptor.FieldDescriptor(
      name='debug_logging', full_name='AnalyzeClientMemoryArgs.debug_logging', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='max_file_size_download', full_name='AnalyzeClientMemoryArgs.max_file_size_download', index=4,
...
_MEMORYINFORMATION.fields_by_name['device'].message_type = grr.proto.jobs_pb2._PATHSPEC
_MEMORYINFORMATION.fields_by_name['runs'].message_type = grr.proto.jobs_pb2._BUFFERREFERENCE
_PLUGINREQUEST.fields_by_name['args'].message_type = grr.proto.jobs_pb2._DICT
_REKALLREQUEST.fields_by_name['iterator'].message_type = grr.proto.jobs_pb2._ITERATOR
_REKALLREQUEST.fields_by_name['plugins'].message_type = _PLUGINREQUEST
_REKALLREQUEST.fields_by_name['device'].message_type = grr.proto.jobs_pb2._PATHSPEC
_REKALLREQUEST.fields_by_name['session'].message_type = grr.proto.jobs_pb2._DICT
...
MemoryInformation = _reflection.GeneratedProtocolMessageType('MemoryInformation', (_message.Message,), dict(
  ...
  __module__ = 'grr.client.components.rekall_support.rekall_pb2'
...
_ANALYZECLIENTMEMORYARGS.fields_by_name['driver_installer']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\342\374\343\304\001\205\001\022\200\001An optional DriverInstallTemplate proto to control driver installation. If not set, the default installation proto will be used.\030\002'))
...
_ANALYZECLIENTMEMORYARGS.fields_by_name['use_kcore_if_present'].has_options = True
_ANALYZECLIENTMEMORYARGS.fields_by_name['use_kcore_if_present']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\342\374\343\304\001Q\0227Use /proc/kcore if present. Only affects linux clients.\"\026Enable kcore scanning.'))
