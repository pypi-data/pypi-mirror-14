...
if sys.platform.startswith("darwin"):
    libfile = os.path.join(path_prefix, "osx/mjpro/bin/libmujoco130.dylib")
elif sys.platform.startswith("linux"):
    libfile = os.path.join(path_prefix, "linux/mjpro/bin/libmujoco130.so")
elif sys.platform.startswith("win"):
    libfile = os.path.join(path_prefix, "windows/mjpro/bin/mujoco130.lib")
else:
