...
def _load_library():
    ...
    if sys.platform.startswith("darwin"):
        libfile = os.path.join(path_prefix, "osx/mujoco/libglfw.dylib")
    elif sys.platform.startswith("linux"):
        libfile = os.path.join(path_prefix, "linux/mujoco/libglfw.so")
    elif sys.platform.startswith("win"):
        libfile = os.path.join(path_prefix, "win/mujoco/glfw3.dll")
    else:
