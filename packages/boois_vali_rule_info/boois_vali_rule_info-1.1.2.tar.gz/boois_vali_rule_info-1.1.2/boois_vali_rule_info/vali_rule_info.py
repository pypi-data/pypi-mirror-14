...
本模块用于输入参数的合法性
'''
from boois_cmd_parser.boois_cmd_parser.cmd_parser import cmd_parser
...
class ValiRuleInfo(object):
    ...
    REGX_TMP = {
        ...
        "mobi": r"^0?1[0-9]{10}$",  # 手机号 +86 13599999999
        ...
        "ip": r"^((?:(?:25[0-5]|2[0-4]\d|((1\d{2})|([1-9]?\d)))\.){3}(?:25[0-5]|2[0-4]\d|((1\d{2})|([1-9]?\d))))$",  # ip地址
...
if __name__ == "__main__":
    info = ValiRuleInfo(r' field -i test%s123123 -n -l 1,4 -r "/mo\" -bi/gi" -t "-int|+float"')
    print info
