...
class PointerGesturePinchV1(Interface):
...
@PointerGesturePinchV1.event("uuou", [None, None, wl_Surface, None])
...
@PointerGesturePinchV1.event("uffff", [None, None, None, None, None])
...
@PointerGesturePinchV1.event("uui", [None, None, None])
def end(self, serial, time, cancelled):
    """Multi-finger pinch end

    This event is sent when a multi-finger pinch gesture ceases to be valid.
    This may happen when one or more finger is lifted or the gesture is
    cancelled.
