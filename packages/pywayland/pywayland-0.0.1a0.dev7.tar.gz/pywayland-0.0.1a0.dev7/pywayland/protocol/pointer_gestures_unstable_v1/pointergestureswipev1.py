...
class PointerGestureSwipeV1(Interface):
...
@PointerGestureSwipeV1.event("uuou", [None, None, wl_Surface, None])
...
@PointerGestureSwipeV1.event("uff", [None, None, None])
...
@PointerGestureSwipeV1.event("uui", [None, None, None])
