...
class EOSDriver(NetworkDriver):
    ...
    def get_interfaces(self):
        """Implemantation of NAPALM method get_interfaces."""
        commands = list()
    ...
    def get_lldp_neighbors(self):
        """Implemantation of NAPALM method get_lldp_neighbors."""
        commands = list()
    ...
    def get_interfaces_counters(self):
        """Implemantation of NAPALM method get_interfaces_counters."""
        commands = list()
    ...
    def get_environment(self):
        """Implemantation of NAPALM method get_environment."""
        command = list()
    ...
    def get_lldp_neighbors_detail(self, interface=''):
        """Implemantation of NAPALM method get_lldp_neighbors_detail."""
                ...
                lldp_neighbors_out[interface].append(
                    {
                        ...
                        'remote_system_enable_capab': unicode(', '.join(
                                        [capability for capability in capabilities.keys() if capabilities[capability]]))
                    }
                )
