...
#                   'fontcolor':'red',
    ...
    *Engineering Elective Requirements: 
    ...
    courses of 3 or more credits with course 
    prefixes of BIOE, CHE, CEE, CSE, ECE, MAT, 
    ME, or MECH for which the prerequisites 
    are met may be selected. Certain courses 
    with these prefixes that are excluded 
    from consideration are listed at: 
    ...
    G.add_node('Eng Req', label = label, fontsize = '44', shape = 'plaintext', fontname = 'Times')
