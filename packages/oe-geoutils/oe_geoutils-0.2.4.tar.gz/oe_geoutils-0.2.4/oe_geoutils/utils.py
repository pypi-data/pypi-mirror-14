...
class AdminGrenzenClient:
    ...
    def _get_admin_objecten(self, geojson_input, admin_grens_type, geef_geometrie=0):
    ...
    def get_gemeenten(self, geojson_input):
        ...
        """
        results = self._get_admin_objecten(geojson_input, 'gemeente')
    ...
    def get_gemeente(self, geojson_input):
        ...
        :return: municipality
        """
        results = self._get_admin_objecten(geojson_input, 'gemeente', 1)
    ...
    def get_provincie(self, geojson_input):
        ...
        :return: province
        """
        results = self._get_admin_objecten(geojson_input, 'provincie', 1)
        return self._get_lagest_admin_obj(results, geojson_input)
