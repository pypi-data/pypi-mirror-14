...
For an address of Belgium the validation uses the CRAB principles.
'''
...
class CrabAdresSchemaNode(colander.MappingSchema):
            ...
            if gemeente:
                ...
                if straat_id:
                    ...
                    if straat_val:
                        ...
                        num_val = self._process_huisnummer(adres, huisnummer_id, huisnummer, straat_val)
                        if num_val:
                            self._process_subadres(adres, subadres_id, subadres, num_val)
    ...
    @staticmethod
    def _process_huisnummer(adres, huisnummer_id, huisnummer, straat_val):
        num_val = None
        if straat_val:
            if huisnummer_id:
    ...
    @staticmethod
    def _process_subadres(adres, subadres_id, subadres, num_val):
        subadres_val = None
        if num_val:
            if subadres_id:
