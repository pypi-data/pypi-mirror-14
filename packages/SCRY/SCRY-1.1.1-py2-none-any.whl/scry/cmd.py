...
def cmd(args=None):
    ...
    service_cmds = [('dir',"change SCRY's working directory",
                    ...
                    ('install','download new services from PyPI',
                     'Download and install new services from PyPI using pip.'),
    ...
    p['start'].add_argument('-d','--debug',help="start SCRY in debug mode, ignoring the configuration file's debug setting")
