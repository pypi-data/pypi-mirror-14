...
# Superclass of OrbHandler, ServiceHandler, VarServiceHandler, ValuesHandler, FilterHandler and BindHandler
...
### END OF ServiceHandler


class VarServiceHandler(ServiceHandler):
    def __init__(self,query_handler,var):
        super(VarServiceHandler,self).__init__(query_handler,None,None)
        self.subject = var
