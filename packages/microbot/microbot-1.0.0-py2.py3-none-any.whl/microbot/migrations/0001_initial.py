# -*- coding: utf-8 -*-
# Generated by Django 1.9.4 on 2016-04-10 15:14
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('token', models.CharField(db_index=True, help_text='Token provided by Telegram API https://core.telegram.org/bots', max_length=100, validators=[microbot.validators.validate_token], verbose_name='Token')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chat', models.OneToOneField(help_text='Chat in Telegram API format. https://core.telegram.org/bots/api#chat', on_delete=django.db.models.deletion.CASCADE, to='microbot.Chat', verbose_name='Chat')),
            ],
            options={
