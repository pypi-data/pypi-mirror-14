...
description = 'A simple python library for easily creating command line applications, use Python\'s decorators to ' \
              'manage subcommands and positional and optional arguments.'
...
setup(
    ...
    install_requires='argcomplete==1.1.0',
    classifiers=[
