    ...
    if 'AutoScalingGroups' in response:
        ...
        if len(stacks) > 0:
            ...
            if 'ScheduledUpdateGroupActions' in response:
                stacks = response.get('ScheduledUpdateGroupActions')

                if len(stacks) > 0:
                    for s in stacks:
                        print("\n")
                        print('###########################')
                        print('ScheduledUpdateGroupActions')
                        print('###########################')
                        print(pretty(s))
                    ...
                    print("\n")
                    print("#############################################")
                    print('No Auto Scaling ScheduledUpdateGroupActions')
                    print("#############################################")
            else:
                print("\n")
                print("#############################################")
