    ...
    if 'MetricAlarms' in response:
        ...
        if len(stacks) > 0:
            ...
            for s in stacks:
                ...
                my_list.append(s['AlarmName'])
                my_list.append(s['ActionsEnabled'])

                if s['ActionsEnabled'] == False:
                    continue
            ...
            print "\n"
            print '###############################'
            print '## Select Alarm To Disable   ##'
            print '###############################'
            for key in sorted(menu):
                print str(key)+": " + str(menu[key][0]) +' - '+str(menu[key][1])+' - Enbled: '+str(menu[key][3])+' - '+str(menu[key][2])
