...
from aws_cli_menu.commons.case_class import CaseClass
from aws_cli_menu.commons.string import to_unicode
...
class TerminalHandler(CaseClass):
    ...
    def __init__(self, term_type=None, encoding=None,
        ...
        if (DEBUG):
            print('commons.terminal.py - __init__(self,term_type=None, encoding=None) - called by:'+str(inspect.stack()[1][3]))
    ...
    def _can_getch_enable(stdin):
        if (DEBUG):
            print('commons.terminal.py - _get_getch_enable(stdin) - called by:'+str(inspect.stack()[1][3]))
    ...
    def _detect_term_type():
        ...
        """
        if (DEBUG):
            print('commons.terminal.py - _detect_term_type() - called by:'+str(inspect.stack()[1][3]))
    ...
    def _detect_encoding(stdout):
        ...
        """
        if (DEBUG):
            print('commons.terminal.py - _detect_encoding(stdout) - called by:'+str(inspect.stack()[1][3]))
    ...
    def _get_restore_function(self):
        ...
        """
        if (DEBUG):
            print('commons.terminal.py - _get_restore_function(self) - called by:'+str(inspect.stack()[1][3]))
    ...
    def clear(self):
        ...
        """
        if (DEBUG):
            print('commons.terminal.py - clear(self) - called by:'+str(inspect.stack()[1][3]))
    ...
    def clear_input_buffer(self):
        ...
        """
        if (DEBUG):
            print('commons.terminal.py - clear_input_buffer() - called by:'+str(inspect.stack()[1][3]))
    ...
    def getch(self):
        ...
        """
        if (DEBUG):
            print('commons.terminal.py - getch() - called by:'+str(inspect.stack()[1][3]))
    ...
    def _get_one_char(self):
        if (DEBUG):
            print('commons.terminal.py - _get_one_char() - called by:'+str(inspect.stack()[1][3]))
    ...
    def _check_key_repeat(self, ch):
        if (DEBUG):
            print('commons.terminal.py - _check_key_repeat() - called by:'+str(inspect.stack()[1][3]))
    ...
    def gets(self):
        ...
        """
        if (DEBUG):
            print('commons.terminal.py - gets() - called by:'+str(inspect.stack()[1][3]))
