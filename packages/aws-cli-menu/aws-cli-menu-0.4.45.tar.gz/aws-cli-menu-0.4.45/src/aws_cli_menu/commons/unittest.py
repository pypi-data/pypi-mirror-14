...
from aws_cli_menu.commons.string import to_bytes, to_str
...
class StringBuffer(object):
    ...
    def __init__(self, init_buffer=None):
        if (DEBUG):
            print('commons.unittest.py - __init__(self,init_buffer=None)- called by:'+str(inspect.stack()[1][3]))

        self._buffer = init_buffer or b''

    def write(self, s, encoding='utf-8', errors='strict'):
        if (DEBUG):
            print('commons.unittest.py -StringBuffer - write(self,s,encoding,errors)- called by:'+str(inspect.stack()[1][3]))

        self._buffer += to_bytes(s, encoding, errors)

    def writelines(self, lines, encoding='utf-8', errors='strict'):
        if (DEBUG):
            print('commons.unittest.py - StringBuffer - writelines(self,lines,encoding,errors)- called by:'+str(inspect.stack()[1][3]))
    ...
    def getvalue(self, encoding='utf-8', errors='strict'):
        if (DEBUG):
            print('commons.unittest.py - StringBuffer - getvalue(self,encoding,errors)- called by:'+str(inspect.stack()[1][3]))
