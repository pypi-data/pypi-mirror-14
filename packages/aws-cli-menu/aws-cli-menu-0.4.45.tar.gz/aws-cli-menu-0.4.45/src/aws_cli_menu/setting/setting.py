...
from aws_cli_menu.commons.functional import omap, oget
from aws_cli_menu.commons.string import to_unicode

from aws_cli_menu.setting import arg_parser
from aws_cli_menu.setting.loader import Loader
from aws_cli_menu.entity import Menu, Meta
from aws_cli_menu.exceptions import SettingError, ConfigError
import inspect


DEBUG=0

DEFAULT_CONFIG_NAME = os.environ.get('AWS_CLI_MENU_CONFIG', 'aws-cli-menu.yml')
EVAL_CACHE_DIR = os.path.join(os.path.expanduser('~'), '.aws-cli-menu', 'eval')
COMMAND_PID_DIR = os.path.join(os.path.expanduser('~'), '.aws-cli-menu', 'pid')
...
class Setting(CaseClass):
    ...
    def __init__(self, config_path=None, work_dir=None, root_menu=None, encoding=None, lang=None, width=None,
        ...
        work_dir = '/usr/share/aws-cli-menu/'
