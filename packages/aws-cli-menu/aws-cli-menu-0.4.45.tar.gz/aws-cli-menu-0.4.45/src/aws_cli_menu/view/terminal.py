...
from aws_cli_menu.commons.string import *
from aws_cli_menu.commons.io import print_safe
from aws_cli_menu.commons.types import *
from aws_cli_menu.entity import Menu, Command
from aws_cli_menu.exceptions import EncodingError, SettingError
from aws_cli_menu.view import i18n
import inspect
import re
...
class Terminal(object):
    def __init__(self, root_menu, host, user, executor, handler, width=None, page_size=None, _input=sys.stdin,
        ...
        :param handler: aws_cli_menu.commons.terminal.TerminalHandler instance
        :param width:
        :param page_size:
        :param _input:
        :param _output:
