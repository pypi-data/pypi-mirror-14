...
from aws_cli_menu.commons.collection import get_single_item
from aws_cli_menu.commons.types import *
from aws_cli_menu.entity.meta import Meta
...
class Item(CaseClass):
    ...
    def _is_command_like(content):
        ...
        """
        if (DEBUG):
            print('entity.item.py - Item - _is_command_like()- caller:'+str(inspect.stack()[1][3]))
    ...
    def parse(data, meta, loader, encoding='utf-8', depth=0):
        ...
        """
        if (DEBUG):
            print('entity.item.py - Item - parse()- caller:'+str(inspect.stack()[1][3]))

        from aws_cli_menu.entity import Menu, Command, KEYWORD_META, KEYWORD_INCLUDE, KEYWORD_EVAL
        ...
        if KEYWORD_META in data:
            print("\t"+'found meta keywork in data')
