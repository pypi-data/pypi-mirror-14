...
class RedfishvApi(object):
    ...
    def unimplemented_1(self, identifier, **kwargs):
        """
        retrieve list of management servers
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.unimplemented_1(identifier, callback=callback_function)
    ...
    def unimplemented_2(self, identifier, index, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.unimplemented_2(identifier, index, callback=callback_function)
        ...
        # verify the required parameter 'index' is set
        if ('index' not in params) or (params['index'] is None):
            raise ValueError("Missing the required parameter `index` when calling `unimplemented_2`")
