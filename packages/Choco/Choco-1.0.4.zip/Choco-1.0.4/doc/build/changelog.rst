...
.. changelog::
    ...
    .. change::
      ...
      from the Choco "filter" operator, provided the operator is enclosed
...
.. changelog::
    ...
    .. change::
      ...
      Compatibility changes; in order to modernize the codebase, Choco
    ...
    .. change::
      ...
      choco-render is now implemented as a setuptools entrypoint script;
      a standalone choco.cmd.cmdline() callable is now available, and the
    ...
    .. change::
      ...
      The choco-render script will now catch errors and run them
    ...
    .. change::
      ...
      A rework of the choco-render script allows the script to run
      correctly when given a file pathname that is outside of the current
      directory, e.g. ``choco-render ../some_template.choco``.  In this case,
...
.. changelog::
    ...
    .. change::
      ...
      Fixed bug where choco-render script wasn't
...
.. changelog::
    ...
    .. change::
      ...
      containing the Choco Context object.
...
.. changelog::
    ...
    .. change::
      ...
      version checks and not allowing Choco 0.6 to
...
.. changelog::
    ...
    .. change::
      ...
      the group "choco.cache", or registered directly
      using choco.cache.register_plugin().  The
      core plugin is the choco.cache.CacheImpl
      class.
    ...
    .. change::
      ...
      Added "--var name=value" option to the choco-render
...
.. changelog::
    ...
    .. change::
      ...
      (see http://techspot.zzzeek.org/2010/11/19/quick-choco-vs.-jinja-speed-test/).
    ...
    .. change::
      ...
      render() as well as Choco builtins
...
.. changelog::
    ...
    .. change::
      ...
      errors.text_error_template which
...
.. changelog::
    ...
    .. change::
      ...
      format_errors=True will now be as a Python
...
.. changelog::
    ...
    .. change::
      ...
      Fix choco function decorators to preserve the
...
.. changelog::
    ...
    .. change::
      ...
      When Choco creates subdirectories in which
    ...
    .. change::
      ...
      added "choco.__version__" attribute to
      the base module.
...
.. changelog::
    ...
    .. change::
      ...
      fixed Python 2.3 compat. in choco.pyparser
...
.. changelog::
    ...
    .. change::
      ...
      added a runner script "choco-render" which renders
    ...
    .. change::
      ...
      import="*"/> - fixed lexer errors not cleaning up
    ...
    .. change::
      ...
      fixed issue with inline format_errors that was
    ...
    .. change::
      ...
      format_errors will apply the encoding options of
...
.. changelog::
    ...
    .. change::
      ...
      (0.7.1) also fixes a bug related to how Choco was using the
      cache API.
...
.. changelog::
    ...
    .. change::
      ...
      added choco.ext.preprocessors package, contains one preprocessor so far:
...
.. changelog::
    ...
    .. change::
      ...
      by default (this is what Choco already does). By setting to [], expressions
