...
PACKAGE_NAME = 'djangocms-bs3-theme-solid'
PACKAGE_DOWNLOAD_URL = 'https://github.com/Nekmo/djangocms-bs3-theme-solid/archive/master.zip'  # .tar.gz
URL = 'https://github.com/Nekmo/djangocms-bs3-theme-solid'  # Project url
STATUS_LEVEL = 1  # 1:Planning 2:Pre-Alpha 3:Alpha 4:Beta 5:Production/Stable 6:Mature 7:Inactive
KEYWORDS = ['djangocms', 'themes', 'bootstrap3', 'djangocms-bs3-theme', 'style', 'template']  # Palabras clave
