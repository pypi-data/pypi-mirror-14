...
setup(
    ...
    url="https://github.com/smartdeveloperhub/sdh-qualitative-metrics",
    download_url="https://github.com/smartdeveloperhub/sdh-qualitative-metrics/tarball/0.0.1",
    packages=find_packages(exclude=['ez_setup', 'examples', 'tests']),
    namespace_packages=['sdh', 'sdh.metrics'],
    install_requires=['SDH-Metrics'],
    classifiers=[],
    scripts=['sdh-qualitative-metrics']
)
