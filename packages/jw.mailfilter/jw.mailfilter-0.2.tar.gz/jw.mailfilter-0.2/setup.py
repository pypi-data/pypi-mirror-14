...
setup(
    ...
    entry_points={
        ...
        'jw.mailfilter.filter': [
            'all = mailfilter.filter:All',
            'rbl = mailfilter.filter:RblFilter',
            'pyzor = mailfilter.filter:PyzorFilter',
            'url = mailfilter.filter:UrlFilter',
            'body = mailfilter.filter:BodyFilter',
            'header = mailfilter.filter:HeaderFilter',
        ],
    ...
    url="https://pypi.python.org/pypi/mailfilter"
)
