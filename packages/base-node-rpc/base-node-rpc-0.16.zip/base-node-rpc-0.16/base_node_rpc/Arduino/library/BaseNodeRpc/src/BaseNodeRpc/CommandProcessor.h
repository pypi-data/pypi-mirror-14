...
/* #########################################################################
 * [2016-04-26 07:51:45.199000] THIS FILE IS AUTOGENERATED - DO NOT EDIT!
 * ######################################################################### */
        ...
        case CMD_BASE_NODE_SOFTWARE_VERSION:
          {
            ...
            /* Call method, unpacking arguments from request structure. */
            response.result =
        ...
        case CMD_ARRAY_LENGTH:
          {
            ...
            /* Compute start address of serialized array descriptors.
             * (i.e., request structure address plus total size of non-array request members). */
            uint8_t *arrays_start = (uint8_t *)&request + 0;

            
            { /* ## Array argument 0: `array` ## */
              uint32_t *descriptor_i = reinterpret_cast<uint32_t *>(arrays_start + 0 * 2 * sizeof(uint32_t));
              /* Extract data length from serialized array descriptor. */
              const uint32_t length_i = descriptor_i[0];
              /* Extract data offset from serialized array descriptor. */
              const uint32_t offset_i = descriptor_i[1];

              /* Set the members for array argument 0 in request structure. */
              request.array.length = length_i;
              request.array.data = (uint8_t *)((uint8_t *)&request + offset_i);
            }
        ...
        case CMD_ECHO_ARRAY:
          {
            ...
            { /* ## Array argument 0: `array` ## */
              ...
              /* Set the members for array argument 0 in request structure. */
              request.array.length = length_i;
              request.array.data = (uint32_t *)((uint8_t *)&request + offset_i);
            }
        ...
        case CMD_STR_ECHO:
          {
            ...
            { /* ## Array argument 0: `msg` ## */
              ...
              /* Set the members for array argument 0 in request structure. */
              request.msg.length = length_i;
              request.msg.data = (uint8_t *)((uint8_t *)&request + offset_i);
            }
        ...
        case CMD_UPDATE_EEPROM_BLOCK:
          {
            ...
            /* Compute start address of serialized array descriptors.
             * (i.e., request structure address plus total size of non-array request members). */
            uint8_t *arrays_start = (uint8_t *)&request + 4;

            
            { /* ## Array argument 0: `data` ## */
              uint32_t *descriptor_i = reinterpret_cast<uint32_t *>(arrays_start + 0 * 2 * sizeof(uint32_t));
              /* Extract data length from serialized array descriptor. */
              const uint32_t length_i = descriptor_i[0];
              /* Extract data offset from serialized array descriptor. */
              ...
              /* Set the members for array argument 0 in request structure. */
              request.data.length = length_i;
              request.data.data = (uint8_t *)((uint8_t *)&request + offset_i);
            }
        ...
        case CMD_I2C_WRITE:
          {
            ...
            /* Compute start address of serialized array descriptors.
             * (i.e., request structure address plus total size of non-array request members). */
            uint8_t *arrays_start = (uint8_t *)&request + 1;
