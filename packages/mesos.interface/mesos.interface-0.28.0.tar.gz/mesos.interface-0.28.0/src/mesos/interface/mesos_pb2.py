...
_FRAMEWORKINFO_CAPABILITY_TYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TASK_KILLING_STATE', index=1, number=2,
      options=None,
      type=None),
  ],
  containing_type=None,
...
class CgroupInfo(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType

  class NetCls(_message.Message):
    __metaclass__ = _reflection.GeneratedProtocolMessageType
...
class WeightInfo(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
