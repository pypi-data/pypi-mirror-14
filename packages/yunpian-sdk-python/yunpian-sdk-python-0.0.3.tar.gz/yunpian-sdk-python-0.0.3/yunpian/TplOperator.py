...
class TplOperator(object):
    ...
    def get_default(self, data={}):
        ...
        return request_post(yunpian_config['URI_GET_DEFAULT_TEMPLATE'], data)

    def get(self, data={}):
        data['apikey'] = self.apikey;

        return request_post(yunpian_config['URI_GET_TEMPLATE'], data)
    ...
    def add(self, data={}):
        ...
        return request_post(yunpian_config['URI_ADD_TEMPLATE'], data)
    ...
    def upd(self, data={}):
        ...
        return request_post(yunpian_config['URI_UPD_TEMPLATE'], data)
    ...
    def delete(self, data={}):
        ...
        return request_post(yunpian_config['URI_DEL_TEMPLATE'], data)
