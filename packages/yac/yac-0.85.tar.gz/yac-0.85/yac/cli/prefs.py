...
def main():
    ...
    # optional args
    parser.add_argument('--registry',  help='specify the connection params for a private registry',
                                       action='store_true')
    ...
    parser.add_argument('--clear', help='clear a vpc definition from registry (arg of "local" will clear all preferences currently in use locally')    
    ...
    if args.clear:
        ...
        if args.clear == 'local':
            print "Clearing vpc and private registry preferences currently in place"
            raw_input("Hit Enter to continue >> ")
            clear_vpc_prefs()
