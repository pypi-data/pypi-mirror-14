...
def apply_fxn_leaf(key, source_dict, params):
    ...
    if key == 'yac-ref':
        ...
        include_file = source_dict[key]

        print "to include: %s"%include_file

        # get dict from file
        # included_dict = get_file_contents(include_file)

        # print included_dict
        # render any params into the dictionary
        #return apply_fxn(included_dict, params)
        return {}
