...
def get_stack_templates(service_descriptor, vpc_prefs, service_parmeters, no_ecs):
    ...
    # see if ECS should be disabled on this stack
    #if ('Resources' in stack_template and 
    #    no_ecs and
    #    'Service' in stack_template['Resources'] ):

        # remove the service portion of the template.
        # This will prevent ECS from creating a service for the cluster on this stack
...
def get_ec2_ips( stack_name , name_search_string=""):
