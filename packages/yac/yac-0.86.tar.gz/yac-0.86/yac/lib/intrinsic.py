...
def get_params_script_path(script_path_arg, params):
    ...
    if file_in_registry(script_path_arg):
        ...
        script_contents = get_file_contents(script_path_arg)

        file_parts = urlparse.urlparse(script_path_arg)
        # remove the leading slash
        script_file_rel_path = file_parts.path[1:]
        ...
        with open(script_file_path,'w') as script_file_path_fp:
           script_file_path_fp.write(script_contents)
