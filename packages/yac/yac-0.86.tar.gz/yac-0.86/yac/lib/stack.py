...
def get_all_stock_resources():
    ...
    # TBD: allow additions or overrides via vpc preferences
...
def get_stack_templates(service_descriptor, vpc_prefs, service_parmeters):
    ...
    template_files = _get_stock_template_files(stock_resources, vpc_prefs)
...
def _get_stock_template_files(stock_resources, vpc_prefs):

    stock_templates = {}
    vpc_prefs_template_map = {}

    # get template map provided in the vpc preferences
    if 'stock-resources' in vpc_prefs:
        vpc_prefs_template_map = vpc_prefs['stock-resources']
