...
class LoggerToolFactory(ToolFactory):
    ...
    def __init__(self, logger_level="INFO"):
        super(LoggerToolFactory, self).__init__(logger_level)
...
class CommonToolFactory(ToolFactory):
    ...
    def __init__(self, logger_level="INFO"):
        super(CommonToolFactory, self).__init__(logger_level)
...
class InternetToolFactory(ToolFactory):
    ...
    def __init__(self, logger_level="INFO"):
        super(InternetToolFactory, self).__init__(logger_level)
...
class DataBaseToolFactory(ToolFactory):
    ...
    def __init__(self, logger_level="INFO"):
        super(DataBaseToolFactory, self).__init__(logger_level)
        self.default_logger.debug("create DataBaseToolFactory")

    def get_MYSQL_Connector(self, host, user, passwd, port):
        res = MYSQLDataBaseConnector(
            self.default_logger, host, user, passwd, port)
        return res
