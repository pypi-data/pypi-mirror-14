...
#define XML_STREAM_XS_IDC(c) ((c)-2015gs & \
    (XML_PATTERN_XSSEL | XML_PATTERN_XSFIELD))

#define XML_STREAM_XS_IDC_SEL(c) ((c)-2015gs & XML_PATTERN_XSSEL)

#define XML_STREAM_XS_IDC_FIELD(c) ((c)-2015gs & XML_PATTERN_XSFIELD)
