...
class DocBookWriter(writers.Writer):
    ...
    def __init__(self, root_element,
                 document_id = None, output_xml_header=True, lang=None):
    ...
    def translate(self):
        ...
        self.visitor = DocBookTranslator(self.document, self.document_type,
                self.document_id, self.output_xml_header, lang=self.lang)
...
class DocBookTranslator(nodes.NodeVisitor):
    ...
    def __init__(self, document, document_type, document_id = None,
                 output_xml_header=True, lang=None):
        """
        Initialize the translator.

        Takes the root element of the resulting DocBook output as its sole
        argument.
        """
    ...
    def visit_document(self, node):
        ...
        element = {'{http://www.w3.org/XML/1998/namespace}id': self.document_id,
                   'version': '5.0'}
        if self.lang is not None:
            element['{http://www.w3.org/XML/1998/namespace}lang'] = self.lang
        self._push_element(self.document_type, element)
