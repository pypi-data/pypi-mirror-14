...
def cmdline():
    ...
    parser.add_argument('-r', '--remote', dest='remote_repo', default=bgdata.remote_repository_url(), help="Remote repository URL")
    parser.add_argument('-l', '--local', dest='local_repo', default=bgdata.local_repository_url(), help="Local repository folder")
