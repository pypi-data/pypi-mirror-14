...
class MsgType(IntEnum):
    ...
    """ unset message type """
    ACK = 0
    """ empty package (only for ack/round trip timimg) - no ack for this """
    JOIN = 1
...
def guess_class(message_type):
    ...
    :type message_type: int
    :return: The coresponding class or None if not found
...
def guess_message_type(message):
    ...
    :return: The coresponding message  type (MsgType) or None if not found
    :rtype: None | int
    """
...
class APPHeader(object):
    ...
    def timestamp_localize(self, value):
        """
        ...
        if isinstance(value, datetime.datetime):
            ...
            # assumes localtime (and add the microsecond part)
...
class APPMessage(object):
    ...
    def __init__(
        ...
        :rtype: None
        :raises ValueError: Message type not setable
        """
...
class APPUpdateMessage(APPMessage):
    ...
    def __init__(self, device_id=Id.REQUEST, people=None):
        ...
        :type people: None | list[people.People]
        :rtype: None
        :raises ValueError: Message type not setable
        """
        if people is None:
