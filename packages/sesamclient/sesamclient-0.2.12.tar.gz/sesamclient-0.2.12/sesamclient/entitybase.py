...
class EntityBase:
    """
    This is the common baseclass for all the classes that represents various server-side objects (Sink, Provider, etc)
    """
    ...
    @property
    def config(self):
        return self._raw_jsondata.get("config", {})
    ...
    def as_json_object(self):
        ...
        json_obj = copy.deepcopy(self._raw_jsondata)
        return json_obj
