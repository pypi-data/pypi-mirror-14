...
:Returns:
    ...
    out : cf.DimensionCoordinate or None
        ...
        ac.id        = 'atmosphere_hybrid_height_coordinate_a'
        ...
        print TOA_height,  self.height_at_top_of_model
        if TOA_height <= 0:
        ...
        ac.id        = 'atmosphere_hybrid_height_coordinate_b'
...
:Returns:
    ...
    out : cf.DimensionCoordinate or None
        ...
        ac = AuxiliaryCoordinate()
        ac = self.coord_data(ac, array, bounds, units=_Units['1'])
        ac.id        = 'atmosphere_hybrid_height_coordinate_bk'
...
#             * If theta level: C for rho level above
        ...
        domain.insert_aux(ac, axes=[zdim], copy=False)
        ac.id        = 'atmosphere_hybrid_sigma_pressure_coordinate_bk'
