...
'''
        ...
        for partition in self.partitions.matrix.flat:
            ...
            for axis_size, location, axis in izip(partition.shape, 
                                                  partition.location,
                                                  axes):
                if axis_size == 1 or n_chunks <= 1:
                    continue
                
                if axis_size <= n_chunks:
                    d[axis] = range(location[0]+1, location[1])

                    n_chunks = int(math_ceil(n_chunks/float(axis_size)))
...
'''
    ...
    def mean(self, axes=None, squeeze=False, mtol=1, weights=None, i=False):
        r'''
...
'''
    ...
    @classmethod
    def empty(cls, shape, dtype=None, units=None):
...
'''
    ...
    @classmethod
    def ones(cls, shape, dtype=None, units=None):
        '''
'''
    ...
    @classmethod
    def zeros(cls, shape, dtype=None, units=None):
        '''
'''
...
'''        
    ...
    def var(self, axes=None, squeeze=False, weights=None, mtol=1, ddof=1,
            a=None, i=False):
        r'''
