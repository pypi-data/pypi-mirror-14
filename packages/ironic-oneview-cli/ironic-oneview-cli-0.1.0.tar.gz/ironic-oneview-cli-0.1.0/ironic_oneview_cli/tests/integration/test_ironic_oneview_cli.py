...
class TestIronic_oneview_cli(base.TestCase):
    ...
    def setUp(self):
        ...
        self.facade = Facade(self.config)
#         self.fail(self.config._CONF.__dict__)
    ...
    def test_list_server_hardware_not_enrolled(self):
        ...
        all_sh_count = len(all_sh)
        server_hardwares_not_enrolled = (
            node_creator.list_server_hardware_not_enrolled(all_sh)
        )
        self.assertLessEqual(all_sh_count, len(server_hardwares_not_enrolled))
