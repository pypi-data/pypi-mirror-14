...
(function () {
  'use strict';
    ...
    seriesShowController.$inject = ["$state", "$mdDialog"];
  angular
    .module('flexget.plugins.series')
...
(function () {
  ...
  seriesController.$inject = ["$http", "$mdDialog"];
  angular
    .module('flexget.plugins.series')
...
$templateCache.put("components/error/dialog.tmpl.html","<md-dialog aria-label=\"Error Details\" ng-cloak=\"\"><md-dialog-content><div class=\"md-dialog-content\"><h1>TODO: Add error data</h1><h2>TODO: Check if copy to clipboard is useful, as well as link the open new issue on github</h2><div>{{ vm.error }}</div></div></md-dialog-content><md-dialog-actions layout=\"row\"><md-button ng-click=\"vm.close()\">Close</md-button></md-dialog-actions></md-dialog>");
...
$templateCache.put("plugins/movies/movies.tmpl.html","<md-content flex=\"\" layout-margin=\"\"><md-tabs md-dynamic-height=\"\" md-border-bottom=\"\"><md-tab ng-repeat=\"list in vm.lists\" md-on-select=\"vm.loadMovies(list.id)\"><md-tab-label>{{ list.name }}</md-tab-label><md-tab-body><md-list flex=\"\"><movie-entry movie=\"movie\" delete-movie=\"vm.deleteMovie(list.id, movie)\" ng-repeat=\"movie in vm.movies\"></movie-entry></md-list></md-tab-body></md-tab></md-tabs></md-content>");
...
$templateCache.put("plugins/movies/components/movie-entry/movie-entry.tmpl.html","<md-list-item class=\"md-2-line md-long-text\"><div class=\"md-list-item-text\"><h3>{{ vm.movie.title }} ({{ vm.movie.year }})</h3><p ng-repeat=\"id in ::vm.movie.movies_list_ids\">{{ ::id.id_name | moviesListIdsFilter }}: {{ ::id.id_value }}</p><md-button class=\"md-raised md-warn\" ng-click=\"vm.deleteMovie()\">Delete</md-button></div></md-list-item>");
