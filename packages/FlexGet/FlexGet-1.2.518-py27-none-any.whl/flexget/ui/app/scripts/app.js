...
$templateCache.put("plugins/movies/movies.tmpl.html","<md-content flex=\"\" layout-margin=\"\"><md-tabs md-dynamic-height=\"\" md-border-bottom=\"\"><md-tab ng-repeat=\"list in vm.lists\" md-on-select=\"vm.loadMovies(list.id)\"><md-tab-label>{{ ::list.name }}</md-tab-label><md-tab-body><md-content layout=\"row\" layout-wrap=\"\" layout-padding=\"\"><movie-entry flex=\"33\" movie=\"::movie\" delete-movie=\"vm.deleteMovie(list.id, movie)\" ng-repeat=\"movie in vm.movies\"></movie-entry></md-content></md-tab-body></md-tab></md-tabs></md-content>");
...
$templateCache.put("plugins/movies/components/movie-entry/movie-entry.tmpl.html","<md-card class=\"movie-entry\"><div class=\"movie-poster\"><img ng-src=\"{{ ::vm.metadata.poster }}\"></div><div class=\"movie-info\"><h3>{{ ::vm.metadata.title }} ({{ ::vm.metadata.year }}) <span class=\"rating\"><md-icon md-font-set=\"fa\" md-font-icon=\"fa-star\"></md-icon><span class=\"md-suhead\">{{ ::vm.metadata.rating | number:2 }}</span></span></h3><md-divider></md-divider><md-chips ng-model=\"::vm.metadata.genres\" readonly=\"true\"><md-chip-template>{{ $chip }}</md-chip-template></md-chips><p class=\"movie-plot\">{{ ::vm.metadata.overview }}</p></div><md-fab-speed-dial md-direction=\"left\" class=\"md-fling movie-more-btn\"><md-fab-trigger><md-button aria-label=\"More\" class=\"md-fab md-mini\"><i class=\"fa fa-bars\" aria-hidden=\"true\"></i></md-button></md-fab-trigger><md-fab-actions><md-button aria-label=\"delete movie\" ng-click=\"vm.deleteMovie()\" class=\"md-fab md-raised md-mini\"><i class=\"fa fa-trash\" aria-hidden=\"true\"></i></md-button><md-button aria-label=\"More info\" class=\"md-fab md-raised md-mini\"><a ng-href=\"http://www.imdb.com/title/{{ ::vm.metadata.imdb_id }}\"><i class=\"fa fa-film\" aria-hidden=\"true\"></i></a></md-button></md-fab-actions></md-fab-speed-dial></md-card>");
