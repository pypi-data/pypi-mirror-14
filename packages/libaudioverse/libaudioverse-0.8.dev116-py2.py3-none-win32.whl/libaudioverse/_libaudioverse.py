...
Lav_ERROR_FILE = 10
Lav_ERROR_FILE_NOT_FOUND = 11
Lav_ERROR_HRTF_INVALID = 12
Lav_ERROR_CANNOT_CROSS_SIMULATIONS = 13
Lav_ERROR_CAUSES_CYCLE = 14
Lav_ERROR_PROPERTY_IS_READ_ONLY = 15
Lav_ERROR_OVERLAPPING_AUTOMATORS = 16
Lav_ERROR_CANNOT_CONNECT_TO_PROPERTY = 17
Lav_ERROR_BUFFER_IN_USE = 18
...
Lav_simulationSetOutputDevice = ctypes.CFUNCTYPE(LavError, LavHandle, ctypes.c_int, ctypes.c_int, ctypes.c_float, ctypes.c_float, ctypes.c_float)(('Lav_simulationSetOutputDevice', libaudioverse_module))
