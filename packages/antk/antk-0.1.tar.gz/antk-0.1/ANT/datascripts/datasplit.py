...
print(item_dev_cold.getnnz() + item_test_cold.getnnz() + user_dev_cold.getnnz() + user_test_cold.getnnz() + both_cold.getnnz() + non_coldratings.getnnz())
...
scipy.io.savemat(args.writepath+'dev/features_user.mat', {'data': toOnehot(i[range(split_size)], non_coldratings.shape[0])})
scipy.io.savemat(args.writepath+'dev/features_item.mat', {'data': toOnehot(j[range(split_size)], non_coldratings.shape[1])})
...
scipy.io.savemat(args.writepath+'test/features_user.mat', {'data': toOnehot(i[test_start:test_end],non_coldratings.shape[0])})
scipy.io.savemat(args.writepath+'test/features_item.mat', {'data': toOnehot(j[range(test_start, test_end)],non_coldratings.shape[1])})
...
scipy.io.savemat(args.writepath+'train/features_user.mat', {'data': toOnehot(i[range(train_start, num_non_cold)], non_coldratings.shape[0])})
scipy.io.savemat(args.writepath+'train/features_item.mat', {'data': toOnehot(j[range(train_start, num_non_cold)], non_coldratings.shape[1])})
