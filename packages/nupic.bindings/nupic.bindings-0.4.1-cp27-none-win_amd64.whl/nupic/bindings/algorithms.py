...
class Connections(object):
    ...
    def leastRecentlyUsedSegment(self, cell, retSegment):
        """leastRecentlyUsedSegment(self, cell, retSegment) -> bool"""
        return _algorithms.Connections_leastRecentlyUsedSegment(self, cell, retSegment)


    def minPermanenceSynapse(self, segment, retSynapse):
        """minPermanenceSynapse(self, segment, retSynapse) -> bool"""
        return _algorithms.Connections_minPermanenceSynapse(self, segment, retSynapse)


    def computeActivity(self, input, permanenceThreshold, synapseThreshold, recordIteration=True):
        """computeActivity(self, input, permanenceThreshold, synapseThreshold, recordIteration=True) -> Activity"""
        return _algorithms.Connections_computeActivity(self, input, permanenceThreshold, synapseThreshold, recordIteration)
