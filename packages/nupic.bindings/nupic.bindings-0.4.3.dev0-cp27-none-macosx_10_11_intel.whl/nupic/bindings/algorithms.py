...
class SpatialPooler(object):
    ...
    def __init__(self, *args): 
        ...
        __init__(self, inputDimensions, columnDimensions, potentialRadius=16, potentialPct=0.5, globalInhibition=True, 
            ...
            maxBoost=10.0, seed=1, spVerbosity=0, wrapAround=True) -> SpatialPooler
        """
...
class Connections(object):
    ...
    def __init__(self, *args): 
        ...
        __init__(self, numCells, maxSegmentsPerCell=MAX_SEGMENTS_PER_CELL, maxSynapsesPerSegment=MAX_SYNAPSES_PER_SEGMENT) -> Connections
        """
    ...
    def computeActivity(self, *args, **kwargs):
        """
        computeActivity(self, input, activePermanenceThreshold, activeSynapseThreshold, matchingPermanenceThreshold, 
            matchingSynapseThreshold, recordIteration=True) -> Activity
        """
    ...
    def matchingSegments(self, *args, **kwargs):
        ...
        return _algorithms.Connections_matchingSegments(self, *args, **kwargs)

    def matchingCells(self, *args, **kwargs):
        """matchingCells(self, activity) -> std::vector< nupic::algorithms::connections::Cell,std::allocator< nupic::algorithms::connections::Cell > >"""
        return _algorithms.Connections_matchingCells(self, *args, **kwargs)
...
class TemporalMemory(object):
    ...
    def __init__(self, *args): 
        ...
        __init__(self, columnDimensions, cellsPerColumn=32, activationThreshold=13, initialPermanence=0.21, 
            ...
            seed=42, maxSegmentsPerCell=MAX_SEGMENTS_PER_CELL, maxSynapsesPerSegment=MAX_SYNAPSES_PER_SEGMENT) -> TemporalMemory
        """
    ...
    def initialize(self, *args, **kwargs):
        ...
        initialize(self, columnDimensions={ 2048 }, cellsPerColumn=32, activationThreshold=13, initialPermanence=0.21, 
            ...
            seed=42, maxSegmentsPerCell=MAX_SEGMENTS_PER_CELL, maxSynapsesPerSegment=MAX_SYNAPSES_PER_SEGMENT)
        """
    ...
    def activateCorrectlyPredictiveCells(self, *args, **kwargs):
        ...
        return _algorithms.TemporalMemory_activateCorrectlyPredictiveCells(self, *args, **kwargs)

    def burstColumns(self, *args, **kwargs):
        ...
        return _algorithms.TemporalMemory_burstColumns(self, *args, **kwargs)

    def learnOnSegments(self, *args, **kwargs):
        """
        learnOnSegments(self, prevActiveSegments, learningSegments, prevActiveCells, winnerCells, prevWinnerCells, 
            _connections, predictedInactiveCells, prevMatchingSegments)
        """
        return _algorithms.TemporalMemory_learnOnSegments(self, *args, **kwargs)

    def computePredictiveCells(self, *args, **kwargs):
        ...
        return _algorithms.TemporalMemory_computePredictiveCells(self, *args, **kwargs)

    def bestMatchingCell(self, *args, **kwargs):
        ...
        return _algorithms.TemporalMemory_bestMatchingCell(self, *args, **kwargs)

    def bestMatchingSegment(self, *args, **kwargs):
        """bestMatchingSegment(self, cell, activeCells, connections) -> tuple< bool,nupic::algorithms::connections::Segment,nupic::Int >"""
        return _algorithms.TemporalMemory_bestMatchingSegment(self, *args, **kwargs)

    def leastUsedCell(self, *args, **kwargs):
        """leastUsedCell(self, cells, connections) -> ConnectionsCell"""
        return _algorithms.TemporalMemory_leastUsedCell(self, *args, **kwargs)

    def activeSynapsesForSegment(self, *args, **kwargs):
        """activeSynapsesForSegment(self, segment, activeCells, connections) -> ConnectionsSynapseVector"""
        return _algorithms.TemporalMemory_activeSynapsesForSegment(self, *args, **kwargs)

    def adaptSegment(self, *args, **kwargs):
        """adaptSegment(self, segment, activeSynapses, connections, permanenceIncrement, permanenceDecrement)"""
        return _algorithms.TemporalMemory_adaptSegment(self, *args, **kwargs)

    def pickCellsToLearnOn(self, *args, **kwargs):
        """pickCellsToLearnOn(self, n, segment, winnerCells, connections) -> std::set< nupic::algorithms::connections::Cell >"""
        return _algorithms.TemporalMemory_pickCellsToLearnOn(self, *args, **kwargs)

    def cellsForColumnCell(self, *args, **kwargs):
        """cellsForColumnCell(self, column) -> ConnectionsCellVector"""
        return _algorithms.TemporalMemory_cellsForColumnCell(self, *args, **kwargs)

    def numberOfCells(self):
        """numberOfCells(self) -> nupic::UInt"""
        return _algorithms.TemporalMemory_numberOfCells(self)

    def mapCellsToColumns(self, *args, **kwargs):
        """mapCellsToColumns(self, cells) -> std::map< nupic::Int,std::set< nupic::algorithms::connections::Cell > >"""
        return _algorithms.TemporalMemory_mapCellsToColumns(self, *args, **kwargs)
    ...
    def _validateColumn(self, *args, **kwargs):
        """_validateColumn(self, column) -> bool"""
        return _algorithms.TemporalMemory__validateColumn(self, *args, **kwargs)
    ...
    def _validateSegment(self, *args, **kwargs):
        """_validateSegment(self, segment) -> bool"""
        return _algorithms.TemporalMemory__validateSegment(self, *args, **kwargs)

    def _validatePermanence(self, *args, **kwargs):
        """_validatePermanence(self, permanence) -> bool"""
        return _algorithms.TemporalMemory__validatePermanence(self, *args, **kwargs)
