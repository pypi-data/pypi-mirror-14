...
class PublicIPAddressDnsSettings(Model):
    ...
    :param str domain_name_label: Gets or sets the Domain name label.The
    ...
    :param str fqdn: Gets the FQDN, Fully qualified domain name of the A DNS
     record associated with the public IP. This is the concatenation of the
     domainNameLabel and the regionalized DNS zone.
    :param str reverse_fqdn: Gets or Sests the Reverse FQDN. A user-visible,
