...
class Model:
    ...
    def __init__(self):
        ...
        self.arrowstraight = ImageTk.PhotoImage(
            file=os.path.join(os.path.dirname(__file__), 'images/arrowstraight.gif'))
...
class Controller:
    ...
    def run(self):
        ...
        self.root.title('METAR and TAF Monitor  - Mark Baker')
        self.root.deiconify()
        self.root.mainloop()
            ...
            if new_metar1 is not None:
                ...
                if new_metar1[1] < self.metar1_prev_state:
                    ...
                    if self.main_view.controls_view.phone_nbr.get() != '':
                        msg1 = self.icao1 + ' DETERIORATED ' + new_metar1[3]
                        self.send_twilio_sms(msg1)
                    msg2 = self.icao1 + ' DETERIORATED'
                    tkMessageBox.showinfo('Colour state change', msg2)
                    ...
                    if self.main_view.controls_view.phone_nbr.get() != '':
                        msg3 = self.icao1 + ' IMPROVEMENT ' + new_metar1[3]
                        self.send_twilio_sms(msg3)
                    msg4 = self.icao1 + ' IMPROVEMENT'
                    tkMessageBox.showinfo('Colour state change', msg4)
        ...
        # ICAO unchanged, update if new METAR, update previous colour states and send notifications of changes
            ...
            if new_metar2 is not None:
                ...
                if new_metar2[1] < self.metar2_prev_state:
                    ...
                    if self.main_view.controls_view.phone_nbr.get() != '':
                        msg5 = self.icao2 + ' DETERIORATED ' + new_metar2[3]
                        self.send_twilio_sms(msg5)
                    msg6 = self.icao2 + ' DETERIORATED '
                    tkMessageBox.showinfo('Colour state change', msg6)
                    ...
                    if self.main_view.controls_view.phone_nbr.get() != '':
                        msg7 = self.icao2 + ' IMPROVEMENT ' + new_metar2[3]
                        self.send_twilio_sms(msg7)
                    msg8 = self.icao2 + ' IMROVEMENT '
                    tkMessageBox.showinfo('Colour state change', msg8)
        ...
        # ICAO unchanged, update if new METAR, update previous colour states and send notifications of changes
            ...
            if new_metar3 is not None:
                ...
                if new_metar3[1] < self.metar3_prev_state:
                    ...
                    if self.main_view.controls_view.phone_nbr.get() != '':
                        msg9 = self.icao3 + ' DETERIORATED ' + new_metar3[3]
                        self.send_twilio_sms(msg9)
                    msg10 = self.icao3 + ' DETERIORATED'
                    tkMessageBox.showinfo('Colour state change', msg10)
                    ...
                    if self.main_view.controls_view.phone_nbr.get() != '':
                        msg11 = self.icao3 + ' IMPROVEMENT ' + new_metar3[3]
                        self.send_twilio_sms(self.icao3 + ' IMPROVEMENT ' + new_metar3[3])
                    msg12 = self.icao3 + ' IMPROVEMENT'
                    tkMessageBox.showinfo('Colour state change', msg12)
        ...
        # ICAO unchanged, update if new METAR, update previous colour states and send notifications of changes
            ...
            if new_metar4 is not None:
                ...
                if new_metar4[1] < self.metar4_prev_state:
                    ...
                    if self.main_view.controls_view.phone_nbr.get() != '':
                        msg13 = self.icao4 + ' DETERIORATED ' + new_metar4[3]
                        self.send_twilio_sms(msg13)
                    msg14 = self.icao4 + ' DETERIORATED'
                    tkMessageBox.showinfo('Colour state change', msg14)
                    ...
                    if self.main_view.controls_view.phone_nbr.get() != '':
                        msg15 = self.icao4 + ' IMPROVEMENT '+ new_metar4[3]
                        self.send_twilio_sms(msg15)
                    msg16 = self.icao4 + ' IMPROVEMENT'
                    tkMessageBox.showinfo('Colour state change', msg16)
    ...
    def update_taf_monitor(self):
        ...
        if self.main_view.taf_view.icao_taf_entry.get() == '':
            ...
            if new_metar_taf[1] >= new_taf[1]:
                ...
                if self.main_view.controls_view.phone_nbr.get() != '':
                    msg17 = self.icao_taf + ' TAF BUST!'
                    self.send_twilio_sms(msg17)
                msg18 = self.icao_taf + ' TAF BUST!'
                tkMessageBox.showinfo('TAF monitor', msg18)
    ...
    def send_twilio_sms(self, message):
        ...
        try:
            ...
            errormsg = 'SMS sending error: ' + e
            tkMessageBox.showerror('SMS message error', errormsg)
