...
class Controller:
    ...
    def run(self):
        ...
        self.root.title('METAR and TAF Monitor v0.8.2')
        self.root.deiconify()
        self.root.mainloop()
    ...
    def data_check_sched(self):
        ...
        into one job"""
        scheduler = BackgroundScheduler(job_defaults=sched_job_defaults)
        ...
        # ICAO unchanged, update if new METAR, update previous colour states and send notifications of changes
            ...
            if new_metar1 is not None:
                ...
                if new_metar1[1] < self.metar1_prev_state:
                    ...
                    tkMessageBox.showinfo('Colour state change', self.icao1 + ' DETERIORATED')
                    ...
                    tkMessageBox.showinfo('Colour state change', self.icao1 + ' IMPROVEMENT')
        ...
        # ICAO unchanged, update if new METAR, update previous colour states and send notifications of changes
            ...
            if new_metar2 is not None:
                ...
                if new_metar2[1] < self.metar2_prev_state:
                    ...
                    tkMessageBox.showinfo('Colour state change', self.icao2 + ' DETERIORATED ')
                    ...
                    tkMessageBox.showinfo('Colour state change', self.icao2 + ' IMPROVEMENT ')
                else:
                    if new_metar2[1] == self.metar2_prev_state:
                        self.main_view.metar_view.metar2_arrow_label.configure(image=self.model.arrowstraight)
        ...
        # ICAO unchanged, update if new METAR, update previous colour states and send notifications of changes
            ...
            if new_metar3 is not None:
                ...
                if new_metar3[1] < self.metar3_prev_state:
                    ...
                    tkMessageBox.showinfo('Colour state change', self.icao3 + ' DETERIORATED')
                    ...
                    tkMessageBox.showinfo('Colour state change', self.icao3 + ' IMPROVEMENT')
        ...
        # ICAO unchanged, update if new METAR, update previous colour states and send notifications of changes
            ...
            if new_metar4 is not None:
                ...
                if new_metar4[1] < self.metar4_prev_state:
                    ...
                    tkMessageBox.showinfo('Colour state change', self.icao4 + ' DETERIORATED')
                    ...
                    tkMessageBox.showinfo('Colour state change', self.icao4 + ' IMPROVEMENT')
    ...
    def update_taf_monitor(self):
        ...
        if self.main_view.taf_view.icao_taf_entry.get() == '':
            ...
            if new_metar_taf[1] >= new_taf[1]:
                ...
                tkMessageBox.showinfo('TAF monitor', self.icao_taf + ' TAF BUST!')
    ...
    def send_twilio_sms(self, message):
        ...
        4/03/2016 - disabled this facility for now as my trial account has expired.
        """
