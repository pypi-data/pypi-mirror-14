...
Resources.add_resource('/static/shark/js/raphael-min.js', 'js', 'morris', 'raphael')
Resources.add_resource('/static/shark/js/morris.min.js', 'js', 'morris', 'main')
Resources.add_resource('/static/shark/css/morris.css', 'css', 'morris', 'main')