...
class NavBar(BaseObject):
    ...
    def get_html(self, html):
        ...
        html.append(u'            <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#{}_items" aria-controls="bs-navbar" aria-expanded="false">'.format(self.id))
