...
class SitesOperations(object):
    ...
    def get_slots_differences_from_production(
        ...
        :param boolean raw: returns the direct response alongside the
         deserialized response
        :rtype: SlotDifferenceCollection
        :rtype: msrest.pipeline.ClientRawResponse if raw=True
        """
        slot_swap_entity = models.CsmSlotEntity(target_slot=target_slot, preserve_vnet=preserve_vnet)
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('SlotDifferenceCollection', response)
    ...
    def update_slot_config_names(
        ...
        :type slot_config_names: SlotConfigNamesResource
        :param dict custom_headers: headers that will be added to the request
        :param boolean raw: returns the direct response alongside the
         deserialized response
        :rtype: SlotConfigNamesResource
    ...
    def recover_site(
        ...
        :param name: Name of web app
        :type name: str
        :param snapshot: Snapshot data used for web app recovery. Snapshot
         information can be obtained by call GetDeletedSites API.
        :type snapshot: CsmSiteRecoveryEntity
        :param dict custom_headers: headers that will be added to the request
        :param boolean raw: returns the direct response alongside the
         deserialized response
        :rtype: object
        ...
        # Construct body
        body_content = self._serialize.body(snapshot, 'CsmSiteRecoveryEntity')
    ...
    def recover_site_slot(
            self, resource_group_name, name, snapshot, slot, custom_headers={}, raw=False, **operation_config):
        """
        Recovers a deleted web app
    ...
    def get_site_snapshots_on_sku(
        ...
        :param webspace_name: Webspace
        :type webspace_name: str
        ...
        query_parameters['webspaceName'] = self._serialize.query("webspace_name", webspace_name, 'str')
        query_parameters['api-version'] = self._serialize.query("self.config.api_version", self.config.api_version, 'str')
    ...
    def get_deleted_sites(
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('DeletedSiteCollection', response)
    ...
    def get_deployments(
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('DeploymentCollection', response)
    ...
    def get_site_instance_identifiers(
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('SiteInstanceCollection', response)
    ...
    def get_site_host_name_bindings_slot(
        ...
        :param boolean raw: returns the direct response alongside the
         deserialized response
        :rtype: HostNameBindingCollection
        :rtype: msrest.pipeline.ClientRawResponse if raw=True
        """
        # Construct URL
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('HostNameBindingCollection', response)
    ...
    def create_or_update_site_host_name_binding(
        ...
        :type host_name_binding: HostNameBinding
        :param dict custom_headers: headers that will be added to the request
        :param boolean raw: returns the direct response alongside the
         deserialized response
        :rtype: HostNameBinding
    ...
    def update_site_app_settings(
        ...
        :type app_settings: StringDictionary
        :param dict custom_headers: headers that will be added to the request
        :param boolean raw: returns the direct response alongside the
         deserialized response
        :rtype: StringDictionary
    ...
    def list_site_connection_strings(
        ...
        :param boolean raw: returns the direct response alongside the
         deserialized response
        :rtype: ConnectionStringDictionary
        :rtype: msrest.pipeline.ClientRawResponse if raw=True
        """
        # Construct URL
    ...
    def update_site_connection_strings(
        ...
        :type connection_strings: ConnectionStringDictionary
        :param dict custom_headers: headers that will be added to the request
        :param boolean raw: returns the direct response alongside the
         deserialized response
        :rtype: ConnectionStringDictionary
    ...
    def update_site_auth_settings(
        ...
        :type site_auth_settings: SiteAuthSettings
        :param dict custom_headers: headers that will be added to the request
        :param boolean raw: returns the direct response alongside the
         deserialized response
        :rtype: SiteAuthSettings
    ...
    def update_site_metadata(
        ...
        :type metadata: StringDictionary
        :param dict custom_headers: headers that will be added to the request
        :param boolean raw: returns the direct response alongside the
         deserialized response
        :rtype: StringDictionary
    ...
    def update_site_logs_config(
        ...
        :type site_logs_config: SiteLogsConfig
        :param dict custom_headers: headers that will be added to the request
        :param boolean raw: returns the direct response alongside the
         deserialized response
        :rtype: SiteLogsConfig
    ...
    def get_site_metric_definitions(
        ...
        :param boolean raw: returns the direct response alongside the
         deserialized response
        :rtype: MetricDefinitionCollection
        :rtype: msrest.pipeline.ClientRawResponse if raw=True
        """
        # Construct URL
    ...
    def get_site_relay_service_connection(
        ...
        :param boolean raw: returns the direct response alongside the
         deserialized response
        :rtype: RelayServiceConnectionEntity
        :rtype: msrest.pipeline.ClientRawResponse if raw=True
        """
        # Construct URL
    ...
    def create_or_update_site_relay_service_connection(
        ...
        :type connection_envelope: RelayServiceConnectionEntity
        :param dict custom_headers: headers that will be added to the request
        :param boolean raw: returns the direct response alongside the
         deserialized response
        :rtype: RelayServiceConnectionEntity
