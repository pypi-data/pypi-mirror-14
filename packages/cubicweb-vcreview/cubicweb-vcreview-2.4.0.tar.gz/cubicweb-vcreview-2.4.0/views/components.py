...
class ActivityComponent(component.EntityCtxComponent):
    ...
    def render_body(self, w):
        ...
        if self.entity.has_eid():
            ...
            eid = None
            form['tempEid'] = self.entity.eid
            form['etype'] = self.entity.cw_etype
        data['data-form'] = json_dumps(form)
        ...
        if (req.vreg.schema['Task'].has_perm(req, 'add') and
            ...
            w(tags.a(req._('add a task'), href="#", klass="cwjs-vcreview-add-activity",
                     **data))
