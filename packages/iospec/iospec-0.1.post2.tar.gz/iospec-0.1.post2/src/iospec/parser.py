...
class IoSpecParser:
    ...
    def __init__(self, source, commands=None):
        ...
        self.groups = group_blocks(enumerate(self.source.splitlines()))
    ...
    def parse_plain_input(self, lines):
        ...
        if line.strip() != '@plain':
            ...
            return InputTestCase(data, inline=True)
        ...
        return InputTestCase(cases, inline=False)
    ...
    def parse_input_block(self, lines):
        ...
        for i, x in enumerate(cases):
            ...
            if x.startswith('$'):
                ...
                cases[i] = In(x)
        return InputTestCase(cases, inline=inline)
