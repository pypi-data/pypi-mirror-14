...
def parse_args(argv=()):
    ...
    p.add_argument('--noshow', action='store_true', help="call external program to display graph")
    ...
    p.add_argument('--max-bacon', type=int, default=2, metavar="INT", help="exclude nodes that are more than n hops away")
