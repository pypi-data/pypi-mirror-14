...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('committees_committee', (
            ...
            ('content', self.gf('tendenci.libs.tinymce.models.HTMLField')()),
            ...
            ('mission', self.gf('tendenci.libs.tinymce.models.HTMLField')(null=True, blank=True)),
            ('notes', self.gf('tendenci.libs.tinymce.models.HTMLField')(null=True, blank=True)),
