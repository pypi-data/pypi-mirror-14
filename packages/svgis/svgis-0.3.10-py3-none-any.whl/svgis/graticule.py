...
def graticule(bounds, step, crs=None):
    ...
    if crs:
        ...
        bounds = projection.transform_bounds({'init': 'epsg:4326'}, out_crs, bounds)
        unproject = partial(fiona.transform.transform, out_crs, {'init': 'epsg:4326'})
