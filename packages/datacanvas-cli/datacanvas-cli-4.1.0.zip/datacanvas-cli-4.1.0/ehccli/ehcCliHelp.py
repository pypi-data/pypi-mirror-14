...
class ehcCliHelp:
    ...
    def showEhcCliCmdHelp(self):
        ...
        print self.color.bold+"The sqlcommands: "+self.color.end
    ...
    def showJobCmdOperation(self):
        ...
        print self.color.bold+"o createjobfromoutside"+self.color.end
        print self.color.bold+"o createjob"+self.color.end
        print self.color.bold+"o jobstatus"+self.color.end
        print self.color.bold+"o onlystatus"+self.color.end
    ...
    def showUserCmdOperation(self):
        ...
        print self.color.bold+"o setdafaultuserkey"+self.color.end
        print self.color.bold+"o userkeycreate"+self.color.end
        print self.color.bold+"o userkeydafault"+self.color.end
