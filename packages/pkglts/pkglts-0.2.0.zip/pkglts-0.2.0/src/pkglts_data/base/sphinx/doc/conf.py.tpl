...
# -*- coding: utf-8 -*-
#
# Package {{key, base.pkgname}} documentation build configuration file, created by
...
htmlhelp_basename = '{{key, base.pkgname}}doc'
...
# [howto/manual]).
latex_documents = [
    ('index', '{{key, base.pkgname}}.tex',
     u'{{key, base.pkgname}} Documentation',
     u'{{key, base.owner}}', 'manual'),
]
