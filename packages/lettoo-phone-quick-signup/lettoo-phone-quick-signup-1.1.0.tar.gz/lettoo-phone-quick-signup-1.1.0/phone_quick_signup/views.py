...
from .models import QuickPhoneConfirmation
...
class RegisterView(APIView, FormView):
    ...
    def form_valid(self, form):
        ...
        return complete_signup(request, self.user, app_settings.PHONE_VERIFICATION)
...
class VerifyPhoneView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if not self.kwargs['phone'] or not self.kwargs['key']:
            return Response({'message': _('phone and key parameters required')}, status=status.HTTP_400_BAD_REQUEST)
