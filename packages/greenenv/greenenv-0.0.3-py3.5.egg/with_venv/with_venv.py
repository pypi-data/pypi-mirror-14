...
import types
import shlex
#from . import artifact_path

import os
artifact_path = os.path.expanduser(os.path.join("~", '.withvenv'))
...
if __name__ == "__main__":
    ...
    with env.create('foo', 'python3.5') as fooenv:
        ...
        fooenv.install_dependency([os.path.expanduser('~/Code/anser-indicus/'), 'numpy', 'pymystem3', 'tables', 'pyparsing', 'scipy', 'sklearn'])#, other_args="-t {}".format(target_dir))
