...
_FILEOPTIONS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='javanano_use_deprecated_package', full_name='google.protobuf.FileOptions.javanano_use_deprecated_package', index=14,
