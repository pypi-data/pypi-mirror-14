...
# Main WlFileBrowser Directory. This has to be a directory within MEDIA_ROOT.
...
# The URL/PATH to your wlfilebrowser media-files.
URL_FILEBROWSER_MEDIA = getattr(settings, "FILEBROWSER_URL_FILEBROWSER_MEDIA", "%swlfilebrowser/" % settings.STATIC_URL)
PATH_FILEBROWSER_MEDIA = getattr(settings, "FILEBROWSER_PATH_FILEBROWSER_MEDIA", os.path.join(settings.MEDIA_ROOT, 'wlfilebrowser/'))
...
# If set to True, the WlFileBrowser will not try to import a mis-installed PIL.
