 ...
 * resources:
 *
 *  1. css: wlfilebrowser/css/smoothness/jquery-ui-1.9.1.custom.min.css
 *  2. js:  wenlincms/js/%s' % settings.JQUERY_FILENAME
 *  3. js:  wlfilebrowser/js/jquery-ui-1.9.1.custom.min.js
 *  4. js:  wlfilebrowser/js/wlfilebrowser-popup.js (this script)
 *
 ...
 * in the CSS. This happens with wenlincms's inline editing for instance,
...
var mediaLibrary = {
	...
	open: function(callback, type) {
		...
		iframe.attr('src', window.__wlfilebrowser_url + '?pop=4&type=' + type);
