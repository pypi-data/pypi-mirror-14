...
class FileBrowseWidget(Input):
    ...
    class Media:
        js = (os.path.join(URL_FILEBROWSER_MEDIA, 'js/AddWlFileBrowser.js'), )
    ...
    def render(self, name, value, attrs=None):
        ...
        final_attrs['search_icon'] = URL_FILEBROWSER_MEDIA + 'img/wlfilebrowser_icon_show.gif'
        ...
        if value != "":
            try:
                ...
                pass
        return render_to_string("wlfilebrowser/custom_field.html", dict(locals(), MEDIA_URL=MEDIA_URL))
...
try:
    ...
    add_introspection_rules([], ["^wlfilebrowser\.fields\.FileBrowseField"])
except ImportError:
    pass
