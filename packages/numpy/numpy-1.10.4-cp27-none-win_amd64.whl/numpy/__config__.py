...
atlas_3_10_blas_threads_info={'libraries': ['numpy-atlas'], 'library_dirs': ['C:\\projects\\np-wheel-builder\\atlas-builds\\atlas-3.11.38-sse2-64\\lib'], 'language': 'c', 'define_macros': [('HAVE_CBLAS', None), ('NO_ATLAS_INFO', -1)]}
lapack_opt_info={'libraries': ['numpy-atlas', 'numpy-atlas'], 'library_dirs': ['C:\\projects\\np-wheel-builder\\atlas-builds\\atlas-3.11.38-sse2-64\\lib'], 'language': 'f77', 'define_macros': [('NO_ATLAS_INFO', -1)]}
