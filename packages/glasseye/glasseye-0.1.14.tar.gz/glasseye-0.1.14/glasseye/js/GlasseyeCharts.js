        ...
        if (method === "bayesian") {
            ...
            self.posterior_diff = function (d, i) {
                ...
                if (self.select_mode === 0) {
                    ...
                    d3.selectAll(self.div).selectAll("#commentary").html("There is a " + d3.format("%")(diff.more_than_zero) + " probability that the number of " + diff.A_label + " in the population is greater that the number of " + diff.B_label);
                }
