...
from .api_views import (
    ...
    APIDeletedDocumentView, APIDocumentDownloadView, APIDocumentDownloadPDFView, APIDocumentView,
...
api_urls = patterns(
    ...
    url(
        r'^documents/(?P<pk>[0-9]+)/download_pdf/$',
        APIDocumentDownloadPDFView.as_view(), name='document-download-pdf'
    ),
    url(
