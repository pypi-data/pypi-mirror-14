...
PACKAGE_NAME = 'mayan-edms-maestropdf'
PACKAGE_DIR = 'mayan'
...
setup(
    ...
    classifiers=[],
    description='A fork of Mayan EDMS that lets you download any document as PDF',
    ...
    url='https://gitlab.com/clickonchris/mayan-edms',
