...
def set_promotion(T1, T2, **_3to2kwargs):
    if 'restype' in _3to2kwargs: restype = _3to2kwargs['restype']; del _3to2kwargs['restype']
    else: restype = None
    if 'symmetric' in _3to2kwargs: symmetric = _3to2kwargs['symmetric']; del _3to2kwargs['symmetric']
    else: symmetric = True
    if 'function' in _3to2kwargs: function = _3to2kwargs['function']; del _3to2kwargs['function']
    else: function = None
