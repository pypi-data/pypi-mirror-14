...
class PredataDataClient(PredataGenericClient):
    ...
    def list_tag_category(self, tag_category_id=None):
        """
    ...
    def list_footprint(self, group_id=None):
        """
        List all footprints.
        """
        endpoint = "footprints/"
    ...
    def get_footprint(self, footprint_id):
        """
        Get asset data.
        """
        endpoint = "footprints/%s/" % footprint_id
        return {
            "footprint_id": footprint_id,
            "result": self.make_request(endpoint)
        }
