...
if version_info >= (2, 6, 0):
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_fiftyone_degrees_mobile_detector_v3_wrapper', [dirname(__file__)])
        except ImportError:
            import _fiftyone_degrees_mobile_detector_v3_wrapper
            return _fiftyone_degrees_mobile_detector_v3_wrapper
        if fp is not None:
            try:
                _mod = imp.load_module('_fiftyone_degrees_mobile_detector_v3_wrapper', fp, pathname, description)
            finally:
                fp.close()
            return _mod
...
class SwigPyIterator(_object):
    ...
    def __iter__(self):
        return self
SwigPyIterator_swigregister = _fiftyone_degrees_mobile_detector_v3_wrapper.SwigPyIterator_swigregister
...
class MapStringString(_object):
    ...
    __del__ = lambda self: None
MapStringString_swigregister = _fiftyone_degrees_mobile_detector_v3_wrapper.MapStringString_swigregister
...
class VectorString(_object):
    ...
    __del__ = lambda self: None
VectorString_swigregister = _fiftyone_degrees_mobile_detector_v3_wrapper.VectorString_swigregister
...
Match_swigregister = _fiftyone_degrees_mobile_detector_v3_wrapper.Match_swigregister
...
Profiles_swigregister = _fiftyone_degrees_mobile_detector_v3_wrapper.Profiles_swigregister
...
Provider_swigregister = _fiftyone_degrees_mobile_detector_v3_wrapper.Provider_swigregister
