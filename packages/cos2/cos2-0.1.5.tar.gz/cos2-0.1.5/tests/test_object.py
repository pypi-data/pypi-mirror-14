...
class TestObject(CosTestCase):
    def test_object(self):
        ...
        def assert_result(result):
            ...
            self.assertEqual(result.content_type, 'application/javascript;charset=UTF-8')
    ...
    def test_anonymous(self):
        ...
        b = cos2.Bucket(cos2.AnonymousAuth(), COS_ENDPOINT, COS_BUCKET)
        ...
        self.assertRaises(cos2.exceptions.AccessDenied, b.put_object, key, content)
        self.assertRaises(cos2.exceptions.AccessDenied, b.get_object, key)
