...
class SphereGaussDoubleSizeOT(Model):
    ...
    Arg=[250.,150,10.,10,1.5e14,1.5e14,2e11,1e10,0.0]            #list of parameters
    Format=["%f","%f","%f","%f","%1.3e","%1.3e","%1.3e","%1.3e","%f"]      #list of c format
    istofit=[True,True,True,True,True,True,False,False,True]    #list of boolean for fitting
