...
SYSTEM_GENERATE_VERSION = "taobao-sdk-python-20160315"
...
class RestApi(object):
    ...
    def __init__(self, domain='gw.api.taobao.com', port = 80):
        ...
        if(plugs.top.getDefaultAppInfo()):
            self.__app_key = plugs.top.getDefaultAppInfo().appkey
            self.__secret = plugs.top.getDefaultAppInfo().secret
    ...
    def set_app_info(self, appinfo):
        #=======================================================================
        # 设置请求的app信息
        # @param appinfo: import plugs.top
        #                 appinfo plugs.top.appinfo(appkey,secret)
        #=======================================================================
