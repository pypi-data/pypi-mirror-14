# -*- coding: utf-8 -*-
#
# asteval documentation build configuration file
#
...
#html_title = None
html_title = 'ASTEVAL: Minimal Python AST evaluator'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = 'ASTEVAL: Minimal Python AST evaluator'
...
latex_documents = [
  ('index', 'asteval.tex', u'asteval documentation',
