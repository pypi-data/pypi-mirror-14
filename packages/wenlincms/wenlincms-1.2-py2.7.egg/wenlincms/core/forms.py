...
from wenlincms.core.models import Orderable
...
if settings.GRAPPELLI_INSTALLED:
    _tinymce_js = ("grappelli/tinymce/jscripts/tiny_mce/tiny_mce.js", settings.TINYMCE_SETUP_JS)
...
class DynamicInlineAdminForm(forms.ModelForm):
    ...
    class Media:
        js = ("wenlincms/js/jquery-ui-1.9.1.custom.min.js",
              "wenlincms/js/admin/dynamic_inline.js",)
...
def get_edit_form(obj, field_names, data=None, files=None):
    ...
    # from wenlincms.forms import fields
    # widget_overrides = {
