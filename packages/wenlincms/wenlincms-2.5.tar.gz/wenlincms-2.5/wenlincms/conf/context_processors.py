...
from wenlincms.utils.cache import (cache_key_prefix, cache_installed,
                                   cache_get, cache_set)
...
def settings(request=None):
    ...
    # file from either wladmin or Django admin if wladmin isn't
    # installed. We don't call it ADMIN_MEDIA_PREFIX in order to avoid
    # any confusion.
    if settings.WLADMIN_INSTALLED:
        settings_dict["wenlincms_ADMIN_PREFIX"] = "wladmin/"
    else:
        settings_dict["wenlincms_ADMIN_PREFIX"] = "admin/"
