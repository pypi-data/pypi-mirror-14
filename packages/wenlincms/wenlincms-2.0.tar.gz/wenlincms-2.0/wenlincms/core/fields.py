...
class RichTextField(models.TextField):
    ...
    def clean(self, value, model_instance):
        ...
        """
        from wenlincms.conf import settings
        from wenlincms.core.defaults import (RICHTEXT_FILTER_LEVEL_NONE,
...
class MultiChoiceField(with_metaclass(models.SubfieldBase, models.CharField)):
    ...
    def formfield(self, *args, **kwargs):
        from wenlincms.core.forms import CheckboxSelectMultiple
        defaults = {
...
if "south" in settings.INSTALLED_APPS:
    try:
        ...
        add_introspection_rules(patterns=["wenlincms\.core\.fields\."],
