...
from wenlincms.core.forms import DynamicInlineAdminForm
from wenlincms.core.models import (Orderable, CONTENT_STATUS_PUBLISHED)
...
class DisplayableAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (_("Meta data"), {
            "fields": ["slug", "description", "keywords", ],
...
class StackedDynamicInlineAdmin(BaseDynamicInlineAdmin, admin.StackedInline):
    ...
    def __init__(self, *args, **kwargs):
        ...
        the order field.
        """
        wladmin_name = getattr(settings, "PACKAGE_NAME_WLADMIN")
