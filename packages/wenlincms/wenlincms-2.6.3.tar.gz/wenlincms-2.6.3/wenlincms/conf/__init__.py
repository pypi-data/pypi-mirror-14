...
def register_setting(name=None, label=None, editable=False, description=None,
    ...
    """
    if name is None:
        raise TypeError("wenlincms.conf.register_setting requires the "
    ...
    registry[name] = {"name": name, "label": label, "editable": editable,
                      ...
                      "choices": choices, "type": setting_type, "widget": widget}
...
mezz_first = lambda app: not app.startswith("wenlincms.")
