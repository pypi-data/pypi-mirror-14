A personal HTTP server for serving one-time-use bash scripts (think
installers)
...
You can also get the curl without the bomb by specifying --survey, which
only outputs the inner curl command.
