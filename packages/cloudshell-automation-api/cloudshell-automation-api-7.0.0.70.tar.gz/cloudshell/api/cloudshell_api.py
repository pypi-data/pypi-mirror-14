...
class CloudShellAPISession(CommonAPISession):
    ...
    def AddNewUser(self, username='', password='', email='', isActive='', isAdmin=''):
        """
            ...
            :param str isActive: Grant or deny active access to the application.
            :param str isAdmin: Add the user to the System Administrators group.
    ...
    def AddRoutesToReservation(self, reservationId='', sourceResourcesFullPath=[], targetResourcesFullPath=[], mappingType='', maxHops=0, routeAlias='', isShared=''):
        """
            ...
            :param str isShared: Specify whether these routes are shared. Shared routes can be used in more than one reservation.
    ...
    def CreateRouteInReservation(self, reservationId='', sourceResourceFullPath='', targetResourceFullPath='', overrideActiveRoutes='', mappingType='', maxHops=0, routeAlias='', isShared=''):
        """
            ...
            :param str overrideActiveRoutes: Specify whether the new route can override existing routes.
            :param str mappingType: Specify bidirectional or unidirectional as the mapping type.
            :param int maxHops: Specify the maximum number or allowed hops.
            :param str routeAlias: Specify the route’s alias.
            :param str isShared: Specify whether this route is shared. Shared routes can be used in more than one reservation.
    ...
    def DeleteReservation(self, reservationId='', unmap=''):
        """
            ...
            :param str reservationId: Specify the string that represents the reservation’s unique identifier.
            :param str unmap: Specify whether to keep mappings or release mapped resources when deleting the reservation.
    ...
    def DeployAppToCloudProvider(self, reservationId='', appName='', commandInputs=dict(), printOutput=False):
        """
    ...
    def DeployAppToCloudProviderBulk(self, reservationId='', appNames=[], commandInputs=dict(), printOutput=False):
        """
    ...
    def InstallApp(self, reservationId='', resourceName='', commandName='', commandInputs=dict(), printOutput=False):
        """
    ...
    def GenerateUtilizationReport(self, resourceFamilyName='', fromDate='', toDate='', resourceFullName='', resourceModelName='', includeChildResources='', groupBy='', utilizationReportType=''):
        """
            ...
            :param str includeChildResources: Specify whether to include child resources utilization.
    ...
    def SaveReservationAsTopology(self, reservationId='', folderFullPath='', topologyName='', includeInactiveRoutes=''):
        """
            ...
            :param str includeInactiveRoutes: Include disconnected routes in the created topology
    ...
    def SetResourceSharedState(self, reservationId='', resourcesFullName=[], isShared=''):
        """
            ...
            :param str isShared: Specify whether to allow sharing of the resource.
