...
class ESIndividual(Individual):
    ...
    def __init__(self, learning_param1=None,
        ...
        learning_param2 : float, optional
            ...
            is chosen according to [Beyer2002]_.
        strategy_params : iterable of float, optional
            The strategy parameters (mutation strengths) to be adapted.
            As a default, [0.25, ..., 0.25] is chosen.
    ...
    def recombine(self, others):
        ...
        for individual in parents:
            if individual.strategy_params is None:
                individual.strategy_params = [1.0] * num_variables
        # begin recombination
        child = self.clone()
