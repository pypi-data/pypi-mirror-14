...
class Quote:
    ...
    def quote_xml(self, dict_param):
        try:
            ...
            xml_str += '<Date>' + self.date_now.strftime("%Y-%m-%d") + '</Date>' # for weekend its change for us
            ...
            xml_str += '<LocalProductCode>P</LocalProductCode>'
            xml_str += '</QtdShp>'
            ...
            xml_str += '<City>' + addresses['to_country'] + '</City>'
            xml_str += '</To>'
            # To Address ENDS
