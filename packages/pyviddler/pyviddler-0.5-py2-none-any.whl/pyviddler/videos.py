...
class VideosAPI(object):
    ...
    def getDetails(self, video_id="", url="", **kwargs):  # NOQA
        """
    ...
    def getByUser(self, **kwargs):  # NOQA
        """
        page - number - optional (defaults to 1)
    ...
    def setPermalink(self, video_id, permalink=""):  # NOQA
        result = self._get('setPermaLink', video_id=video_id, permalink=permalink)
        return result['video']

    def setDetails(self, video_id, **kwargs):  # NOQA
        """
    ...
    def setThumbnail(self, video_id, timepoint=None, thumbfile=None):  # NOQA
    ...
    def prepareUpload(self, allow_replace=False):  # NOQA
        """
    ...
    def uploadProgress(self, token):  # NOQA
    ...
    def addClosedCaptioning(self, video_id, language, closed_captioning_url, default=True):  # NOQA
        result = self._post('addClosedCaptioning', video_id=video_id,
            language=language, closed_captioning_url=closed_captioning_url,
            default=default)
        return result['video']

    def delClosedCaptioning(self, closed_captioning_id):  # NOQA
