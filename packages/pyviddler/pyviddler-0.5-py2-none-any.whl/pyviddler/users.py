...
class UsersAPI(object):
    ...
    def setProfile(self, **kwargs):  # NOQA
    ...
    def setSettings(self, **kwargs):  # NOQA
        """
    ...
    def getPlayerBranding(self):  # NOQA
    ...
    def setPlayerBranding(self, **kwargs):  # NOQA
        """
