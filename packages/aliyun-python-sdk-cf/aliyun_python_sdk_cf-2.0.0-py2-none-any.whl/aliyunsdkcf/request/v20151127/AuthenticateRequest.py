...
class AuthenticateRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'CF', '2015-11-27', 'Authenticate')
		self.set_protocol_type('https');

	def get_Serno(self):
		return self.get_query_params().get('Serno')

	def set_Serno(self,Serno):
		self.add_query_param('Serno',Serno)
