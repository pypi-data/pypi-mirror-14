...
class SitesEndpoint(BaseEndpoint):
    ...
    def create(self, site, fields=None):
        """ Create a new site.
        :param site: The site to add to your account.
        :param fields: Fields to retrieve of the Site created.
    ...
    def update(self, site, fields=None):
        """ Update a site.
        :param site: Site instance including the modifications to save.
        :param fields: Fields of the object to retrieve.
