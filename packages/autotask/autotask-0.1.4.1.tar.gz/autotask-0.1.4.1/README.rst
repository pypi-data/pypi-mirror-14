...
Other examples are image-processing or whatever may consume some time and can get handled separately.
...
Also keep in mind that handling a lot of delayed tasks may add an additional load to the database. It depends on the application whether this will be an issue.
