...
class GetAttrRestTest(unittest.TestCase, RestTest):
    ...
    def assert_success(self, exp_uri, path=None, id_=None):
        ...
        self.assert_called_once_with(exp_uri)
    ...
    def test_empty_path(self):
        self.run_command("/")
        self.assert_called_once_with("/v1/files/%2F/info/attributes")
...
class SetFileAttrRestTest(unittest.TestCase, RestTest):
    ...
    def test_success(self):
        self.run_command(self.mode, self.owner, self.group, self.size,
            ...
            self.if_match)
        self.assert_called_once_with("/v1/files/2/info/attributes",
...
class GetAclRestTest(unittest.TestCase, RestTest):
    ...
    def test_empty_path(self):
        self.run_command("/")
        self.assert_called_once_with("/v1/files/%2F/info/acl")
...
class SetAclRestTest(unittest.TestCase, RestTest):
    ...
    def test_acl(self):
        ...
        self.run_command(path="/foo", aces=aces, control=control,
                         if_match=if_match)
        self.assert_called_once_with("/v1/files/%2Ffoo/info/acl", body=body,
                              if_match=if_match)
        self.run_command(id_="1", aces=aces, control=control, if_match=if_match)
        self.assert_called_once_with("/v1/files/1/info/acl", body=body,
            if_match=if_match)
...
class CreateFileRestTest(unittest.TestCase, RestTest):
    ...
    def assert_success(self, name, exp_uri, dir_path=None, dir_id=None):
        ...
        self.assert_called_once_with(exp_uri, body=self.body)
...
class DeleteRestTest(unittest.TestCase, RestTest):
    ...
    def test_success(self):
        ...
        self.assert_called_once_with("/v1/files/%2Ffoo")

    def test_empty_path(self):
        self.run_command("/")
        self.assert_called_once_with("/v1/files/%2F")
...
class WriteFileRestTest(unittest.TestCase, RestTest):
    ...
    def assert_success(self, path, id_, exp_uri):
        ...
        self.assert_called_once_with(exp_uri, body_file=body_file,
            if_match=if_match, request_content_type=CONTENT_TYPE_BINARY)
...
class ReadFileRestTest(unittest.TestCase, RestTest):
    ...
    def assert_success(self, exp_uri, path=None, id_=None):
        ...
        self.assert_called_once_with(exp_uri, response_file=response_file,
