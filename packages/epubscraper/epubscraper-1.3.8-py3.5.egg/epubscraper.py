            ...
            if version == '2':
                ...
                if isinstance(val, list):
                    ...
                    for i in range(len(val)):
                        ...
                        res = val[i]['#text']
                        if ty == 'aut':
                            catalog['author'].append(link_parser(res))
                        elif ty == 'trl':
                            catalog['translator'].append(link_parser(res))
                        elif ty == 'edt':
                            catalog['editor'].append(link_parser(res))
                        elif ty == 'ill':
                            catalog['illustrator'].append(link_parser(res))
                else:
                    for m in meta['meta']:
                        try:
                            if m['@refines'] == '#cre':
