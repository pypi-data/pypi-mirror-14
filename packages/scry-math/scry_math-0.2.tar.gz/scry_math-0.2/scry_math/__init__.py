...
from scry.services.classes import Procedure, Argument
...
MATH = Namespace('http://www.scry.rocks/math/')

# SOME ARGUMENTS
arg_dict = {'val_in'      : ('http://www.scry.rocks/math/single-value' , "A single floating point value (Can also be a comma-separated values array!)"),
            'val_out'     : ('http://www.scry.rocks/math/single-value' , "A single floating point value (Can also be a comma-separated values array!)"),
            'array_in'    : ('http://www.scry.rocks/math/csv-array'    , "An array of comma-separated values"),
            'array_out'   : ('http://www.scry.rocks/math/csv-array'    , "An array of comma-separated values"),
            'multi_in'    : ('http://www.scry.rocks/math/2D-array'     , "A rectangular, 2-D array\nRows are separated by semicolons (;)\nValues within rows are separated by commas (,)"),
            'multi_out'   : ('http://www.scry.rocks/math/2D-array'     , "A rectangular, 2-D array\nRows are separated by semicolons (;)\nValues within rows are separated by commas (,)"),
            'param'       : ('http://www.scry.rocks/math/parameter'    , "A parameter value used by certain multi-input functions")}
