...
is the percent cooling rate factor to apply to specimens from this sample, DA-CR-XX is the method code
    ...
    print "or_con=1", or_con
    print "dec_correction_con=1", dec_correction_con
    print "dec_correction=0", dec_correction
    print "bed_correction=True", bed_correction
    print "samp_con='1'", samp_con
    print "hours_from_gmt=0", hours_from_gmt
    print "method_codes=''", method_codes
    print "average_bedding=False", average_bedding
    print "orient_file='orient.txt'", orient_file
    print "samp_file='er_samples.txt'", samp_file
    print "site_file='er_sites.txt'", site_file
    print "output_dir_path='.'", output_dir_path
    print "input_dir_path='.'", input_dir_path
    print "append=False", append
