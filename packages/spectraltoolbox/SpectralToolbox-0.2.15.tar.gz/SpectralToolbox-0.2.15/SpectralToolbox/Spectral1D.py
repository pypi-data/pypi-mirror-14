...
class JacobiPolynomial(OrthogonalPolynomial):
    ...
    def __init__(self, alpha, beta, span=None):
    ...
    def GaussLobattoQuadrature(self, N, norm=False):
        ...
        """
        (a,b) = self.RecursionCoeffs(N)
        (x,w,ierr) = orthpol.dlob(N-1, a, b, -1., 1.)
    ...
    def GaussRadauQuadrature(self, N, norm=False):
        ...
        """
        (a,b) = self.RecursionCoeffs(N)
        (x,w,ierr) = orthpol.dradau(N, a, b, -1.)
    ...
    def Evaluate(self, x, N, alpha=None, beta=None, norm=True):
        ...
        if not norm:
            pend = orthpol.polyeval(np.array([1.]), N, a, b, norm)
...
class LaguerrePolynomial(OrthogonalPolynomial):
    ...
    def Evaluate(self, x, N, alpha=None, norm=True):
        ...
        p = orthpol.polyeval(x, N, a, b, norm)
        if not norm:
            pend = orthpol.polyeval(np.array([0.]), N, a, b, norm)
...
class Fourier(OrthogonalBasis):
    ...
    def Quadrature(self, N, norm=False):
        ...
        .. seealso:: :func:`OrthogonalBasis.Quadrature`
        """
    ...
    def Evaluate(self, x, N):
        ...
        .. seealso:: :func:`OrthogonalBasis.Evaluate`
        """
        if N == 0:
            P = np.ones( x.shape )
        elif N % 2 == 0:
    ...
    def GradEvaluate(self, x, N, k=0, norm=True):
        ...
        .. seealso:: :func:`OrthogonalBasis.GradEvaluate`
        """
        if k == 0:
            P = self.Evaluate(x, N)
        else:
    ...
    def Gamma(self, N):
        ...
        .. seealso:: :func:`OrthogonalBasis.Gamma`
        """
        if N == 0:
            return 2.*np.pi
        else:
    ...
    def project(self, r, f, N):
        ...
        .. seealso:: :func:`OrthogonalBasis.project`
        """
        if len(r) != len(f):
