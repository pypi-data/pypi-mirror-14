 ...
 * resources:
 *
 *  1. css: syfilebrowser/css/smoothness/jquery-ui-1.9.1.custom.min.css
 *  2. js:  shuyucms/js/%s' % settings.JQUERY_FILENAME
 *  3. js:  syfilebrowser/js/jquery-ui-1.9.1.custom.min.js
 *  4. js:  syfilebrowser/js/syfilebrowser-popup.js (this script)
 *
 ...
 * in the CSS. This happens with shuyucms's inline editing for instance,
...
var mediaLibrary = {
	...
	open: function(callback, type) {
		...
		iframe.attr('src', window.__syfilebrowser_url + '?pop=4&type=' + type);
