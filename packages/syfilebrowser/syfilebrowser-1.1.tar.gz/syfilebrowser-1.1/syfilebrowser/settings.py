...
try:
    ...
    DEFAULT_URL_TINYMCE = settings.STATIC_URL + "wladmin/tinymce/jscripts/tiny_mce/"
...
# Main SyFileBrowser Directory. This has to be a directory within MEDIA_ROOT.
...
# The URL/PATH to your syfilebrowser media-files.
URL_FILEBROWSER_MEDIA = getattr(settings, "FILEBROWSER_URL_FILEBROWSER_MEDIA", "%ssyfilebrowser/" % settings.STATIC_URL)
PATH_FILEBROWSER_MEDIA = getattr(settings, "FILEBROWSER_PATH_FILEBROWSER_MEDIA", os.path.join(settings.MEDIA_ROOT, 'syfilebrowser/'))
...
# If set to True, the SyFileBrowser will not try to import a mis-installed PIL.
